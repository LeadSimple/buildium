...
```shell
gem install ./buildium-1.6.0.gem
```

(for development, run `gem install --dev ./buildium-1.6.0.gem` to install the development dependencies)
...
*Buildium::FilesApi* | [**upload_file_request_async**](docs/FilesApi.md#upload_file_request_async) | **POST** /v1/files/uploadrequests | Upload a file
...
*Buildium::TasksApi* | [**create_upload_file_request_async**](docs/TasksApi.md#create_upload_file_request_async) | **POST** /v1/tasks/{taskId}/history/{taskHistoryId}/files/uploadrequests | Upload a task history file
