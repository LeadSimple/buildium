...
*Buildium::AssociationOwnershipAccountsApi* | [**update_ownership_account_charge**](docs/AssociationOwnershipAccountsApi.md#update_ownership_account_charge) | **PUT** /v1/associations/ownershipaccounts/{ownershipAccountId}/charges/{chargeId} | Update a charge
...
*Buildium::LeasesApi* | [**create_lease_ledger_deposit_withholding**](docs/LeasesApi.md#create_lease_ledger_deposit_withholding) | **POST** /v1/leases/{leaseId}/applieddeposits | Create a deposit withholding
