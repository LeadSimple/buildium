...
```shell
gem install ./buildium-ruby-2.2.0.gem
```

(for development, run `gem install --dev ./buildium-ruby-2.2.0.gem` to install the development dependencies)

or publish the gem to a gem hosting service, e.g. [RubyGems](https://rubygems.org/).

Finally add this to the Gemfile:

    gem 'buildium-ruby', '~> 2.2.0'
