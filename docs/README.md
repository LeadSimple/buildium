...
```shell
gem install ./buildium-1.0.0.gem
```

(for development, run `gem install --dev ./buildium-1.0.0.gem` to install the development dependencies)
...
*Buildium::AssociationOwnersApi* | [**create_association_owner**](docs/AssociationOwnersApi.md#create_association_owner) | **POST** /v1/associations/owners | Create an association owner
*Buildium::AssociationOwnersApi* | [**create_association_owner_note**](docs/AssociationOwnersApi.md#create_association_owner_note) | **POST** /v1/associations/owners/{ownerId}/notes | Create an association owner note
*Buildium::AssociationOwnersApi* | [**get_all_association_owners**](docs/AssociationOwnersApi.md#get_all_association_owners) | **GET** /v1/associations/owners | Retrieve all association owners
*Buildium::AssociationOwnersApi* | [**get_association_owner_by_id**](docs/AssociationOwnersApi.md#get_association_owner_by_id) | **GET** /v1/associations/owners/{ownerId} | Retrieve an association owner
*Buildium::AssociationOwnersApi* | [**get_association_owner_note_by_note_id**](docs/AssociationOwnersApi.md#get_association_owner_note_by_note_id) | **GET** /v1/associations/owners/{ownerId}/notes/{noteId} | Retrieve an association owner note
*Buildium::AssociationOwnersApi* | [**get_association_owner_notes**](docs/AssociationOwnersApi.md#get_association_owner_notes) | **GET** /v1/associations/owners/{ownerId}/notes | Retrieve all association owner notes
*Buildium::AssociationOwnersApi* | [**update_association_owner**](docs/AssociationOwnersApi.md#update_association_owner) | **PUT** /v1/associations/owners/{ownerId} | Update an association owner
*Buildium::AssociationOwnersApi* | [**update_association_owner_note**](docs/AssociationOwnersApi.md#update_association_owner_note) | **PUT** /v1/associations/owners/{ownerId}/notes/{noteId} | Update an association owner note
...
*Buildium::AssociationOwnershipAccountsApi* | [**create_association_ownership_account_note**](docs/AssociationOwnershipAccountsApi.md#create_association_ownership_account_note) | **POST** /v1/associations/ownershipaccounts/{ownershipAccountId}/notes | Create an ownership account note
...
*Buildium::AssociationOwnershipAccountsApi* | [**get_association_ownership_account_note_by_note_id**](docs/AssociationOwnershipAccountsApi.md#get_association_ownership_account_note_by_note_id) | **GET** /v1/associations/ownershipaccounts/{ownershipAccountId}/notes/{noteId} | Retrieve an ownership account note
*Buildium::AssociationOwnershipAccountsApi* | [**get_association_ownership_account_notes**](docs/AssociationOwnershipAccountsApi.md#get_association_ownership_account_notes) | **GET** /v1/associations/ownershipaccounts/{ownershipAccountId}/notes | Retrieve all ownership account notes
...
*Buildium::AssociationOwnershipAccountsApi* | [**get_ownership_account_transaction_by_id**](docs/AssociationOwnershipAccountsApi.md#get_ownership_account_transaction_by_id) | **GET** /v1/associations/ownershipaccounts/{ownershipAccountId}/transactions/{transactionId} | Retrieve a single ownership account transaction
*Buildium::AssociationOwnershipAccountsApi* | [**update_association_ownership_account_note**](docs/AssociationOwnershipAccountsApi.md#update_association_ownership_account_note) | **PUT** /v1/associations/ownershipaccounts/{ownershipAccountId}/notes/{noteId} | Update an ownership account note
*Buildium::AssociationTenantsApi* | [**create_association_tenant**](docs/AssociationTenantsApi.md#create_association_tenant) | **POST** /v1/associations/tenants | Create an association tenant
*Buildium::AssociationTenantsApi* | [**create_association_tenant_note**](docs/AssociationTenantsApi.md#create_association_tenant_note) | **POST** /v1/associations/tenants/{tenantId}/notes | Create an association tenant note
*Buildium::AssociationTenantsApi* | [**get_association_tenant_by_id**](docs/AssociationTenantsApi.md#get_association_tenant_by_id) | **GET** /v1/associations/tenants/{tenantId} | Retrieve an association tenant
*Buildium::AssociationTenantsApi* | [**get_association_tenant_note_by_id**](docs/AssociationTenantsApi.md#get_association_tenant_note_by_id) | **GET** /v1/associations/tenants/{tenantId}/notes/{noteId} | Retrieve an association tenant note
*Buildium::AssociationTenantsApi* | [**get_association_tenant_notes**](docs/AssociationTenantsApi.md#get_association_tenant_notes) | **GET** /v1/associations/tenants/{tenantId}/notes | Retrieve all association tenant notes
*Buildium::AssociationTenantsApi* | [**get_association_tenants**](docs/AssociationTenantsApi.md#get_association_tenants) | **GET** /v1/associations/tenants | Retrieve all association tenants
*Buildium::AssociationTenantsApi* | [**update_association_tenant**](docs/AssociationTenantsApi.md#update_association_tenant) | **PUT** /v1/associations/tenants/{tenantId} | Update an association tenant
*Buildium::AssociationTenantsApi* | [**update_association_tenant_note**](docs/AssociationTenantsApi.md#update_association_tenant_note) | **PUT** /v1/associations/tenants/{tenantId}/notes/{noteId} | Update an association tenant note
*Buildium::AssociationUnitsApi* | [**create_association_unit**](docs/AssociationUnitsApi.md#create_association_unit) | **POST** /v1/associations/units | Create an association unit
*Buildium::AssociationUnitsApi* | [**create_association_unit_note**](docs/AssociationUnitsApi.md#create_association_unit_note) | **POST** /v1/associations/units/{unitId}/notes | Create an association unit note
*Buildium::AssociationUnitsApi* | [**get_all_association_units**](docs/AssociationUnitsApi.md#get_all_association_units) | **GET** /v1/associations/units | Retrieve all association units
*Buildium::AssociationUnitsApi* | [**get_association_unit_by_id**](docs/AssociationUnitsApi.md#get_association_unit_by_id) | **GET** /v1/associations/units/{unitId} | Retrieve an association unit
*Buildium::AssociationUnitsApi* | [**get_association_unit_note_by_note_id**](docs/AssociationUnitsApi.md#get_association_unit_note_by_note_id) | **GET** /v1/associations/units/{unitId}/notes/{noteId} | Retrieve an association unit note
*Buildium::AssociationUnitsApi* | [**get_association_unit_notes**](docs/AssociationUnitsApi.md#get_association_unit_notes) | **GET** /v1/associations/units/{unitId}/notes | Retrieve all association unit notes
*Buildium::AssociationUnitsApi* | [**update_association_unit**](docs/AssociationUnitsApi.md#update_association_unit) | **PUT** /v1/associations/units/{unitId} | Update an association unit
*Buildium::AssociationUnitsApi* | [**update_association_unit_note**](docs/AssociationUnitsApi.md#update_association_unit_note) | **PUT** /v1/associations/units/{unitId}/notes/{noteId} | Update an association unit note
...
*Buildium::AssociationsApi* | [**create_association_note**](docs/AssociationsApi.md#create_association_note) | **POST** /v1/associations/{associationId}/notes | Create an association note
...
*Buildium::AssociationsApi* | [**get_association_note_by_note_id**](docs/AssociationsApi.md#get_association_note_by_note_id) | **GET** /v1/associations/{associationId}/notes/{noteId} | Retrieve an association property note
*Buildium::AssociationsApi* | [**get_association_notes**](docs/AssociationsApi.md#get_association_notes) | **GET** /v1/associations/{associationId}/notes | Retrieve all association property notes
...
*Buildium::AssociationsApi* | [**update_association_note**](docs/AssociationsApi.md#update_association_note) | **PUT** /v1/associations/{associationId}/notes/{noteId} | Update an association note
...
*Buildium::BankAccountsApi* | [**update_bank_account_transfer**](docs/BankAccountsApi.md#update_bank_account_transfer) | **PUT** /v1/bankaccounts/{bankAccountId}/transfers/{transferId} | Update a transfer for a bank account
...
*Buildium::LeasesApi* | [**create_lease_credit**](docs/LeasesApi.md#create_lease_credit) | **POST** /v1/leases/{leaseId}/credits | Create a ledger credit
*Buildium::LeasesApi* | [**create_lease_ledger_charge**](docs/LeasesApi.md#create_lease_ledger_charge) | **POST** /v1/leases/{leaseId}/charges | Create a ledger charge
*Buildium::LeasesApi* | [**create_lease_note**](docs/LeasesApi.md#create_lease_note) | **POST** /v1/leases/{leaseId}/notes | Create a lease note
*Buildium::LeasesApi* | [**create_payment**](docs/LeasesApi.md#create_payment) | **POST** /v1/leases/{leaseId}/payments | Create a ledger payment
...
*Buildium::LeasesApi* | [**get_lease_note_by_note_id**](docs/LeasesApi.md#get_lease_note_by_note_id) | **GET** /v1/leases/{leaseId}/notes/{noteId} | Retrieve a lease note
*Buildium::LeasesApi* | [**get_lease_notes**](docs/LeasesApi.md#get_lease_notes) | **GET** /v1/leases/{leaseId}/notes | Retrieve all lease notes
*Buildium::LeasesApi* | [**get_lease_outstanding_balances**](docs/LeasesApi.md#get_lease_outstanding_balances) | **GET** /v1/leases/outstandingbalances | Retrieve all lease outstanding balances
...
*Buildium::LeasesApi* | [**update_lease_note**](docs/LeasesApi.md#update_lease_note) | **PUT** /v1/leases/{leaseId}/notes/{noteId} | Update a lease note
...
*Buildium::RentalOwnersApi* | [**create_rental_owner**](docs/RentalOwnersApi.md#create_rental_owner) | **POST** /v1/rentals/owners | Create a rental owner
*Buildium::RentalOwnersApi* | [**create_rental_owner_note**](docs/RentalOwnersApi.md#create_rental_owner_note) | **POST** /v1/rentals/owners/{rentalOwnerId}/notes | Create a Rental Owner note
*Buildium::RentalOwnersApi* | [**get_rental_owner_by_id**](docs/RentalOwnersApi.md#get_rental_owner_by_id) | **GET** /v1/rentals/owners/{rentalOwnerId} | Retrieve a rental owner
*Buildium::RentalOwnersApi* | [**get_rental_owner_note_by_id**](docs/RentalOwnersApi.md#get_rental_owner_note_by_id) | **GET** /v1/rentals/owners/{rentalOwnerId}/notes/{noteId} | Retrieve a rental owner note
*Buildium::RentalOwnersApi* | [**get_rental_owner_notes**](docs/RentalOwnersApi.md#get_rental_owner_notes) | **GET** /v1/rentals/owners/{rentalOwnerId}/notes | Retrieves all rental owner notes
*Buildium::RentalOwnersApi* | [**get_rental_owners**](docs/RentalOwnersApi.md#get_rental_owners) | **GET** /v1/rentals/owners | Retrieve all rental owners
*Buildium::RentalOwnersApi* | [**update_rental_owner**](docs/RentalOwnersApi.md#update_rental_owner) | **PUT** /v1/rentals/owners/{rentalOwnerId} | Update a rental owner
*Buildium::RentalOwnersApi* | [**update_rental_owner_note**](docs/RentalOwnersApi.md#update_rental_owner_note) | **PUT** /v1/rentals/owners/{rentalOwnerId}/notes/{noteId} | Update a Rental Owner note
*Buildium::RentalPropertiesApi* | [**create_rental_property**](docs/RentalPropertiesApi.md#create_rental_property) | **POST** /v1/rentals | Create a rental property
*Buildium::RentalPropertiesApi* | [**create_rental_property_note**](docs/RentalPropertiesApi.md#create_rental_property_note) | **POST** /v1/rentals/{propertyId}/notes | Create a rental property note
*Buildium::RentalPropertiesApi* | [**get_all_rentals**](docs/RentalPropertiesApi.md#get_all_rentals) | **GET** /v1/rentals | Retrieve all rental properties
*Buildium::RentalPropertiesApi* | [**get_rental_by_id**](docs/RentalPropertiesApi.md#get_rental_by_id) | **GET** /v1/rentals/{propertyId} | Retrieve a rental property
*Buildium::RentalPropertiesApi* | [**get_rental_note_by_note_id**](docs/RentalPropertiesApi.md#get_rental_note_by_note_id) | **GET** /v1/rentals/{propertyId}/notes/{noteId} | Retrieve a rental property note
*Buildium::RentalPropertiesApi* | [**get_rental_notes**](docs/RentalPropertiesApi.md#get_rental_notes) | **GET** /v1/rentals/{propertyId}/notes | Retrieve all rental property notes
*Buildium::RentalPropertiesApi* | [**update_rental_property**](docs/RentalPropertiesApi.md#update_rental_property) | **PUT** /v1/rentals/{propertyId} | Update a rental property
*Buildium::RentalPropertiesApi* | [**update_rental_property_note**](docs/RentalPropertiesApi.md#update_rental_property_note) | **PUT** /v1/rentals/{propertyId}/notes/{noteId} | Update a rental property note
*Buildium::RentalTenantsApi* | [**create_rental_tenant**](docs/RentalTenantsApi.md#create_rental_tenant) | **POST** /v1/leases/tenants | Create a rental tenant
*Buildium::RentalTenantsApi* | [**create_tenant_note**](docs/RentalTenantsApi.md#create_tenant_note) | **POST** /v1/leases/tenants/{tenantId}/notes | Create a lease tenant note
*Buildium::RentalTenantsApi* | [**get_all_tenant_notes**](docs/RentalTenantsApi.md#get_all_tenant_notes) | **GET** /v1/leases/tenants/{tenantId}/notes | Retrieve all tenant notes
...
*Buildium::RentalTenantsApi* | [**get_tenant_note_by_id**](docs/RentalTenantsApi.md#get_tenant_note_by_id) | **GET** /v1/leases/tenants/{tenantId}/notes/{noteId} | Retrieve a tenant note
*Buildium::RentalTenantsApi* | [**update_lease_tenant_note**](docs/RentalTenantsApi.md#update_lease_tenant_note) | **PUT** /v1/leases/tenants/{tenantId}/notes/{noteId} | Update a lease tenant note
*Buildium::RentalTenantsApi* | [**update_rental_tenant**](docs/RentalTenantsApi.md#update_rental_tenant) | **PUT** /v1/leases/tenants/{tenantId} | Update a rental tenant
*Buildium::RentalUnitsApi* | [**create_rental_unit**](docs/RentalUnitsApi.md#create_rental_unit) | **POST** /v1/rentals/units | Create a rental unit
*Buildium::RentalUnitsApi* | [**create_rental_unit_note**](docs/RentalUnitsApi.md#create_rental_unit_note) | **POST** /v1/rentals/units/{unitId}/notes | Create a rental unit note
*Buildium::RentalUnitsApi* | [**get_all_rental_units**](docs/RentalUnitsApi.md#get_all_rental_units) | **GET** /v1/rentals/units | Retrieve all rental property units
*Buildium::RentalUnitsApi* | [**get_rental_unit_by_id**](docs/RentalUnitsApi.md#get_rental_unit_by_id) | **GET** /v1/rentals/units/{unitId} | Retrieve a rental property unit
*Buildium::RentalUnitsApi* | [**get_rental_unit_note_by_note_id**](docs/RentalUnitsApi.md#get_rental_unit_note_by_note_id) | **GET** /v1/rentals/units/{unitId}/notes/{noteId} | Retrieve a rental unit note
*Buildium::RentalUnitsApi* | [**get_rental_unit_notes**](docs/RentalUnitsApi.md#get_rental_unit_notes) | **GET** /v1/rentals/units/{unitId}/notes | Retrieve all rental unit notes
*Buildium::RentalUnitsApi* | [**update_note_for_rental_unit**](docs/RentalUnitsApi.md#update_note_for_rental_unit) | **PUT** /v1/rentals/units/{unitId}/notes/{noteId} | Update a rental unit note
*Buildium::RentalUnitsApi* | [**update_rental_unit**](docs/RentalUnitsApi.md#update_rental_unit) | **PUT** /v1/rentals/units/{unitId} | Update a rental unit
...
*Buildium::TasksApi* | [**update_task_category**](docs/TasksApi.md#update_task_category) | **PUT** /v1/tasks/categories/{taskCategoryId} | Updates a task category
*Buildium::TasksApi* | [**update_to_do_task**](docs/TasksApi.md#update_to_do_task) | **PUT** /v1/tasks/todorequests/{toDoTaskId} | Updates a to do task
...
*Buildium::VendorsApi* | [**create_vendor_note**](docs/VendorsApi.md#create_vendor_note) | **POST** /v1/vendors/{vendorId}/notes | Create a vendor note
...
*Buildium::VendorsApi* | [**get_vendor_note_by_note_id**](docs/VendorsApi.md#get_vendor_note_by_note_id) | **GET** /v1/vendors/{vendorId}/notes/{noteId} | Retrieve a vendor note
*Buildium::VendorsApi* | [**get_vendor_notes**](docs/VendorsApi.md#get_vendor_notes) | **GET** /v1/vendors/{vendorId}/notes | Retrieve all vendor notes
...
*Buildium::VendorsApi* | [**update_vendor_note**](docs/VendorsApi.md#update_vendor_note) | **PUT** /v1/vendors/{vendorId}/notes/{noteId} | Update a vendor note
...
## Documentation for Models
 ...
 - [Buildium::BillAccountingEntitySaveMessage](docs/BillAccountingEntitySaveMessage.md)
 - [Buildium::BillLineMessage](docs/BillLineMessage.md)
 - [Buildium::BillLineSaveMessage](docs/BillLineSaveMessage.md)
