# Buildium::RentalMeterReadingsApi
...
#### Using the delete_meter_reading_details_for_rental_with_http_info variant
...
> <MeterReadingDetailsMessage> upsert_meter_reading_details_for_rental_async(property_id, meter_reading_details_put_message, opts)
...
begin
  # Create/Update meter reading details
  result = api_instance.upsert_meter_reading_details_for_rental_async(property_id, meter_reading_details_put_message, opts)
  p result
rescue Buildium::ApiError => e
...
> <Array(<MeterReadingDetailsMessage>, Integer, Hash)> upsert_meter_reading_details_for_rental_async_with_http_info(property_id, meter_reading_details_put_message, opts)

```ruby
begin
  # Create/Update meter reading details
  data, status_code, headers = api_instance.upsert_meter_reading_details_for_rental_async_with_http_info(property_id, meter_reading_details_put_message, opts)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <MeterReadingDetailsMessage>
rescue Buildium::ApiError => e
