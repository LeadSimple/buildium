...
module Buildium
  class AccountingApi
    ...
    def get_general_ledger_entries_with_http_info(accountingbasis, glaccountids, startdate, enddate, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: AccountingApi.get_general_ledger_entries ...'
      end
      # verify the required parameter 'accountingbasis' is set
      if @api_client.config.client_side_validation && accountingbasis.nil?
        fail ArgumentError, "Missing the required parameter 'accountingbasis' when calling AccountingApi.get_general_ledger_entries"
      end
      # verify enum value
      ...
      # verify the required parameter 'glaccountids' is set
      if @api_client.config.client_side_validation && glaccountids.nil?
        fail ArgumentError, "Missing the required parameter 'glaccountids' when calling AccountingApi.get_general_ledger_entries"
      end
      # verify the required parameter 'startdate' is set
      if @api_client.config.client_side_validation && startdate.nil?
        fail ArgumentError, "Missing the required parameter 'startdate' when calling AccountingApi.get_general_ledger_entries"
      end
      # verify the required parameter 'enddate' is set
      if @api_client.config.client_side_validation && enddate.nil?
        fail ArgumentError, "Missing the required parameter 'enddate' when calling AccountingApi.get_general_ledger_entries"
      end
      ...
      new_options = opts.merge(
        :operation => :"AccountingApi.get_general_ledger_entries",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: AccountingApi#get_general_ledger_entries\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
