...
module Buildium
  class AssociationAppliancesApi
    ...
    def create_association_appliance_with_http_info(association_appliance_post_message, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: AssociationAppliancesApi.create_association_appliance ...'
      end
      ...
      if @api_client.config.client_side_validation && association_appliance_post_message.nil?
        fail ArgumentError, "Missing the required parameter 'association_appliance_post_message' when calling AssociationAppliancesApi.create_association_appliance"
      end
      # resource path
      ...
      new_options = opts.merge(
        :operation => :"AssociationAppliancesApi.create_association_appliance",
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: AssociationAppliancesApi#create_association_appliance\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
    ...
    def create_association_appliance_service_history_with_http_info(appliance_id, association_appliance_service_history_post_message, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: AssociationAppliancesApi.create_association_appliance_service_history ...'
      end
      # verify the required parameter 'appliance_id' is set
      if @api_client.config.client_side_validation && appliance_id.nil?
        fail ArgumentError, "Missing the required parameter 'appliance_id' when calling AssociationAppliancesApi.create_association_appliance_service_history"
      end
      ...
      if @api_client.config.client_side_validation && association_appliance_service_history_post_message.nil?
        fail ArgumentError, "Missing the required parameter 'association_appliance_service_history_post_message' when calling AssociationAppliancesApi.create_association_appliance_service_history"
      end
      # resource path
      ...
      new_options = opts.merge(
        :operation => :"AssociationAppliancesApi.create_association_appliance_service_history",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:POST, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: AssociationAppliancesApi#create_association_appliance_service_history\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def delete_association_appliances_with_http_info(appliance_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: AssociationAppliancesApi.delete_association_appliances ...'
      end
      # verify the required parameter 'appliance_id' is set
      if @api_client.config.client_side_validation && appliance_id.nil?
        fail ArgumentError, "Missing the required parameter 'appliance_id' when calling AssociationAppliancesApi.delete_association_appliances"
      end
      # resource path
      ...
      new_options = opts.merge(
        :operation => :"AssociationAppliancesApi.delete_association_appliances",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: AssociationAppliancesApi#delete_association_appliances\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @option opts [Integer] :offset &#x60;offset&#x60; indicates the position of the first record to return. The &#x60;offset&#x60; is zero-based and the default is 0.
    # @option opts [Integer] :limit &#x60;limit&#x60; indicates the maximum number of results to be returned in the response. &#x60;limit&#x60; can range between 1 and 1000 and the default is 50.
    # @return [Array<(Array<AssociationApplianceServiceHistoryMessage>, Integer, Hash)>] Array<AssociationApplianceServiceHistoryMessage> data, response status code and response headers
    def get_all_association_appliance_service_history_with_http_info(appliance_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: AssociationAppliancesApi.get_all_association_appliance_service_history ...'
      end
      # verify the required parameter 'appliance_id' is set
      if @api_client.config.client_side_validation && appliance_id.nil?
        fail ArgumentError, "Missing the required parameter 'appliance_id' when calling AssociationAppliancesApi.get_all_association_appliance_service_history"
      end
      # resource path
      local_var_path = '/v1/associations/appliances/{applianceId}/servicehistory'.sub('{' + 'applianceId' + '}', CGI.escape(appliance_id.to_s))
      ...
      new_options = opts.merge(
        :operation => :"AssociationAppliancesApi.get_all_association_appliance_service_history",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: AssociationAppliancesApi#get_all_association_appliance_service_history\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def get_association_appliance_by_id_with_http_info(appliance_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: AssociationAppliancesApi.get_association_appliance_by_id ...'
      end
      # verify the required parameter 'appliance_id' is set
      if @api_client.config.client_side_validation && appliance_id.nil?
        fail ArgumentError, "Missing the required parameter 'appliance_id' when calling AssociationAppliancesApi.get_association_appliance_by_id"
      end
      # resource path
      local_var_path = '/v1/associations/appliances/{applianceId}'.sub('{' + 'applianceId' + '}', CGI.escape(appliance_id.to_s))
      ...
      new_options = opts.merge(
        :operation => :"AssociationAppliancesApi.get_association_appliance_by_id",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: AssociationAppliancesApi#get_association_appliance_by_id\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def get_association_appliance_service_history_by_id_with_http_info(appliance_id, service_history_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: AssociationAppliancesApi.get_association_appliance_service_history_by_id ...'
      end
      # verify the required parameter 'appliance_id' is set
      if @api_client.config.client_side_validation && appliance_id.nil?
        fail ArgumentError, "Missing the required parameter 'appliance_id' when calling AssociationAppliancesApi.get_association_appliance_service_history_by_id"
      end
      ...
      if @api_client.config.client_side_validation && service_history_id.nil?
        fail ArgumentError, "Missing the required parameter 'service_history_id' when calling AssociationAppliancesApi.get_association_appliance_service_history_by_id"
      end
      # resource path
      ...
      new_options = opts.merge(
        :operation => :"AssociationAppliancesApi.get_association_appliance_service_history_by_id",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: AssociationAppliancesApi#get_association_appliance_service_history_by_id\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @option opts [Integer] :offset &#x60;offset&#x60; indicates the position of the first record to return. The &#x60;offset&#x60; is zero-based and the default is 0.
    # @option opts [Integer] :limit &#x60;limit&#x60; indicates the maximum number of results to be returned in the response. &#x60;limit&#x60; can range between 1 and 1000 and the default is 50.
    # @return [Array<(Array<AssociationApplianceMessage>, Integer, Hash)>] Array<AssociationApplianceMessage> data, response status code and response headers
    def get_association_appliances_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: AssociationAppliancesApi.get_association_appliances ...'
      end
      # resource path
      local_var_path = '/v1/associations/appliances'
      ...
      new_options = opts.merge(
        :operation => :"AssociationAppliancesApi.get_association_appliances",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: AssociationAppliancesApi#get_association_appliances\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def update_association_appliance_with_http_info(appliance_id, association_appliance_put_message, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: AssociationAppliancesApi.update_association_appliance ...'
      end
      # verify the required parameter 'appliance_id' is set
      if @api_client.config.client_side_validation && appliance_id.nil?
        fail ArgumentError, "Missing the required parameter 'appliance_id' when calling AssociationAppliancesApi.update_association_appliance"
      end
      ...
      if @api_client.config.client_side_validation && association_appliance_put_message.nil?
        fail ArgumentError, "Missing the required parameter 'association_appliance_put_message' when calling AssociationAppliancesApi.update_association_appliance"
      end
      # resource path
      local_var_path = '/v1/associations/appliances/{applianceId}'.sub('{' + 'applianceId' + '}', CGI.escape(appliance_id.to_s))
      ...
      new_options = opts.merge(
        :operation => :"AssociationAppliancesApi.update_association_appliance",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: AssociationAppliancesApi#update_association_appliance\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
  end
