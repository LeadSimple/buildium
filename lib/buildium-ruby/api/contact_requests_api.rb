  ...
  class ContactRequestsApi
    ...
    def create_contact_request_task_with_http_info(contact_request_task_post_message, opts = {})
      ...
      new_options = opts.merge(
        :operation => :"ContactRequestsApi.create_contact_request_task",
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: ContactRequestsApi#create_contact_request_task\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
    ...
    def get_contact_request_task_by_id_with_http_info(contact_request_task_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: ContactRequestsApi.get_contact_request_task_by_id ...'
      end
      ...
      if @api_client.config.client_side_validation && contact_request_task_id.nil?
        fail ArgumentError, "Missing the required parameter 'contact_request_task_id' when calling ContactRequestsApi.get_contact_request_task_by_id"
      end
      # resource path
      ...
      new_options = opts.merge(
        :operation => :"ContactRequestsApi.get_contact_request_task_by_id",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: ContactRequestsApi#get_contact_request_task_by_id\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def get_contact_request_tasks_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: ContactRequestsApi.get_contact_request_tasks ...'
      end
      ...
      new_options = opts.merge(
        :operation => :"ContactRequestsApi.get_contact_request_tasks",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: ContactRequestsApi#get_contact_request_tasks\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def update_contact_request_task_with_http_info(contact_request_task_id, contact_request_task_put_message, opts = {})
      ...
      new_options = opts.merge(
        :operation => :"ContactRequestsApi.update_contact_request_task",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: ContactRequestsApi#update_contact_request_task\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
  end
