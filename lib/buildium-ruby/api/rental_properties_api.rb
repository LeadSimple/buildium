...
module Buildium
  class RentalPropertiesApi
    ...
    def create_rental_unit_image_upload_file_request_async_with_http_info(unit_id, listing_entity_file_post_message, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: RentalPropertiesApi.create_rental_unit_image_upload_file_request_async ...'
      end
      # verify the required parameter 'unit_id' is set
      if @api_client.config.client_side_validation && unit_id.nil?
        fail ArgumentError, "Missing the required parameter 'unit_id' when calling RentalPropertiesApi.create_rental_unit_image_upload_file_request_async"
      end
      # verify the required parameter 'listing_entity_file_post_message' is set
      if @api_client.config.client_side_validation && listing_entity_file_post_message.nil?
        fail ArgumentError, "Missing the required parameter 'listing_entity_file_post_message' when calling RentalPropertiesApi.create_rental_unit_image_upload_file_request_async"
      end
      # resource path
      ...
      new_options = opts.merge(
        :operation => :"RentalPropertiesApi.create_rental_unit_image_upload_file_request_async",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:POST, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: RentalPropertiesApi#create_rental_unit_image_upload_file_request_async\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
