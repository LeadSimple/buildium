...
module Buildium
  class TasksApi
    ...
    def get_rental_owner_request_task_contribution_data_with_http_info(rental_owner_request_task_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: TasksApi.get_rental_owner_request_task_contribution_data ...'
      end
      # verify the required parameter 'rental_owner_request_task_id' is set
      if @api_client.config.client_side_validation && rental_owner_request_task_id.nil?
        fail ArgumentError, "Missing the required parameter 'rental_owner_request_task_id' when calling TasksApi.get_rental_owner_request_task_contribution_data"
      end
      # resource path
      ...
      new_options = opts.merge(
        :operation => :"TasksApi.get_rental_owner_request_task_contribution_data",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: TasksApi#get_rental_owner_request_task_contribution_data\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def update_rental_owner_request_task_contribution_data_with_http_info(rental_owner_request_task_id, rental_owner_contribution_data_put_message, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: TasksApi.update_rental_owner_request_task_contribution_data ...'
      end
      # verify the required parameter 'rental_owner_request_task_id' is set
      if @api_client.config.client_side_validation && rental_owner_request_task_id.nil?
        fail ArgumentError, "Missing the required parameter 'rental_owner_request_task_id' when calling TasksApi.update_rental_owner_request_task_contribution_data"
      end
      ...
      if @api_client.config.client_side_validation && rental_owner_contribution_data_put_message.nil?
        fail ArgumentError, "Missing the required parameter 'rental_owner_contribution_data_put_message' when calling TasksApi.update_rental_owner_request_task_contribution_data"
      end
      # resource path
      local_var_path = '/v1/tasks/rentalownerrequests/{rentalOwnerRequestTaskId}/contributiondata'.sub('{' + 'rentalOwnerRequestTaskId' + '}', CGI.escape(rental_owner_request_task_id.to_s))
      ...
      new_options = opts.merge(
        :operation => :"TasksApi.update_rental_owner_request_task_contribution_data",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:PUT, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: TasksApi#update_rental_owner_request_task_contribution_data\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
