...
module Buildium
  class AnnouncementSearchMessage
    ...
    def self.attribute_map
      {
        :'announcement_date_from' => :'AnnouncementDateFrom',
        :'announcement_date_to' => :'AnnouncementDateTo',
        :'entity_id' => :'EntityId',
    ...
    def self.openapi_types
      {
        :'announcement_date_from' => :'Date',
        :'announcement_date_to' => :'Date',
        :'entity_id' => :'Integer',
        :'entity_type' => :'String',
        :'sender_id' => :'Integer'
      }
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Buildium::AnnouncementSearchMessage` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Buildium::AnnouncementSearchMessage`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }

      if attributes.key?(:'announcement_date_from')
        self.announcement_date_from = attributes[:'announcement_date_from']
      end

      if attributes.key?(:'announcement_date_to')
        self.announcement_date_to = attributes[:'announcement_date_to']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          announcement_date_from == o.announcement_date_from &&
          announcement_date_to == o.announcement_date_to &&
    ...
    def hash
      [announcement_date_from, announcement_date_to, entity_id, entity_type, sender_id].hash
    end
