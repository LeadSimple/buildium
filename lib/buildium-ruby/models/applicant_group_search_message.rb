...
module Buildium
  class ApplicantGroupSearchMessage
    ...
    attr_accessor :application_group_statuses
    ...
    def self.attribute_map
      {
        ...
        :'entity_id' => :'EntityId',
        :'application_group_statuses' => :'ApplicationGroupStatuses',
        :'unit_ids' => :'UnitIds',
        :'name' => :'Name'
      }
    end
    ...
    def self.openapi_types
      {
        :'entity_type' => :'String',
        :'entity_id' => :'Integer',
        :'application_group_statuses' => :'Array<String>',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Buildium::ApplicantGroupSearchMessage` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Buildium::ApplicantGroupSearchMessage`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'application_group_statuses')
        if (value = attributes[:'application_group_statuses']).is_a?(Array)
          self.application_group_statuses = value
        end
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          application_group_statuses == o.application_group_statuses &&
          unit_ids == o.unit_ids &&
          name == o.name
    end
    ...
    def hash
      [entity_type, entity_id, application_group_statuses, unit_ids, name].hash
    end
