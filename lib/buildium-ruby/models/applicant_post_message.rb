...
module Buildium
  ...
  class ApplicantPostMessage
    ...
    attr_accessor :send_rental_application_email
    ...
    def self.attribute_map
      {
        ...
        :'send_rental_application_email' => :'SendRentalApplicationEmail'
      }
    end
    ...
    def self.openapi_types
      {
        ...
        :'last_name' => :'String',
        :'email' => :'String',
        :'phone_numbers' => :'ApplicantPostMessagePhoneNumbers',
        :'send_rental_application_email' => :'Boolean'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Buildium::ApplicantPostMessage` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Buildium::ApplicantPostMessage`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'send_rental_application_email')
        self.send_rental_application_email = attributes[:'send_rental_application_email']
      end
    end
    ...
    def list_invalid_properties
      ...
      if @send_rental_application_email.nil?
        invalid_properties.push('invalid value for "send_rental_application_email", send_rental_application_email cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @send_rental_application_email.nil?
      true
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          send_rental_application_email == o.send_rental_application_email
    end
    ...
    def hash
      [unit_id, first_name, last_name, email, phone_numbers, send_rental_application_email].hash
    end
