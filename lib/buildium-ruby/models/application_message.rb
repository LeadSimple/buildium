...
module Buildium
  class ApplicationMessage
    ...
    # An alpha numeric value that can be used to uniquely identify the application. This is typically provided to an applicant to use as a reference when making inquiries about their application.
    ...
    attr_accessor :application_submitted_date_time
    ...
    def self.attribute_map
      {
        ...
        :'application_submitted_date_time' => :'ApplicationSubmittedDateTime',
    ...
    def self.openapi_types
      {
        ...
        :'application_submitted_date_time' => :'Time',
        :'application' => :'Array<ApplicationResponseMessage>'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Buildium::ApplicationMessage` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Buildium::ApplicationMessage`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'application_status')
        self.application_status = attributes[:'application_status']
      end

      if attributes.key?(:'application_submitted_date_time')
        self.application_submitted_date_time = attributes[:'application_submitted_date_time']
      end

      if attributes.key?(:'application')
        if (value = attributes[:'application']).is_a?(Array)
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          application_submitted_date_time == o.application_submitted_date_time &&
    ...
    def hash
      [id, application_number, application_status, application_submitted_date_time, application].hash
    end
