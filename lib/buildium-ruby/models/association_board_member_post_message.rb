...
module Buildium
  ...
  class AssociationBoardMemberPostMessage
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Buildium::AssociationBoardMemberPostMessage` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Buildium::AssociationBoardMemberPostMessage`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def list_invalid_properties
      ...
      if @association_owner_id.nil?
        invalid_properties.push('invalid value for "association_owner_id", association_owner_id cannot be nil.')
      end

      if @board_position_type.nil?
        invalid_properties.push('invalid value for "board_position_type", board_position_type cannot be nil.')
      end
    ...
    def valid?
      return false if @association_owner_id.nil?
      return false if @board_position_type.nil?
    ...
    def hash
      [association_owner_id, board_position_type, start_date, end_date].hash
    end
