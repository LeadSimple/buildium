...
module Buildium
  class AssociationBoardMemberSearchMessage
    ...
    attr_accessor :board_position_types
    ...
    def self.attribute_map
      {
        :'statuses' => :'Statuses',
        :'board_position_types' => :'BoardPositionTypes',
    ...
    def self.openapi_types
      {
        ...
        :'board_position_types' => :'Array<String>',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Buildium::AssociationBoardMemberSearchMessage` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Buildium::AssociationBoardMemberSearchMessage`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'board_position_types')
        if (value = attributes[:'board_position_types']).is_a?(Array)
          self.board_position_types = value
        end
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          statuses == o.statuses &&
          board_position_types == o.board_position_types &&
    ...
    def hash
      [statuses, board_position_types, created_date_time_to, created_date_time_from].hash
    end
