...
module Buildium
  ...
  class AssociationMessage
    ...
    def self.openapi_types
      {
        ...
        :'address' => :'AssociationMessageAddress',
        :'association_manager' => :'AssociationMessageAssociationManager',
        :'fiscal_year_end_day' => :'Integer',
        :'fiscal_year_end_month' => :'Integer',
        :'tax_information' => :'AssociationMessageTaxInformation'
      }
    end
    ...
    def hash
      [id, name, is_active, reserve, description, year_built, operating_bank_account, operating_bank_account_id, address, association_manager, fiscal_year_end_day, fiscal_year_end_month, tax_information].hash
    end
