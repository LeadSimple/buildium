...
module Buildium
  ...
  class AssociationSearchMessage
    ...
    attr_accessor :operating_bank_account_ids
    ...
    def self.attribute_map
      {
        ...
        :'operating_bank_account_ids' => :'OperatingBankAccountIds'
      }
    end
    ...
    def self.openapi_types
      {
        ...
        :'operating_bank_account_ids' => :'Array<Integer>'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Buildium::AssociationSearchMessage` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Buildium::AssociationSearchMessage`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'operating_bank_account_ids')
        if (value = attributes[:'operating_bank_account_ids']).is_a?(Array)
          self.operating_bank_account_ids = value
        end
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          operating_bank_account_ids == o.operating_bank_account_ids
    end
    ...
    def hash
      [ids, location, status, last_updated_from, last_updated_to, operating_bank_account_ids].hash
    end
