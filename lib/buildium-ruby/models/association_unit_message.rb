  ...
  class AssociationUnitMessage
    ...
    def self.openapi_types
      {
        ...
        :'unit_number' => :'String',
        :'address' => :'AssociationUnitMessageAddress',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Buildium::AssociationUnitMessage` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Buildium::AssociationUnitMessage`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'association_name')
        self.association_name = attributes[:'association_name']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          association_name == o.association_name &&
    ...
    def hash
      [id, association_id, association_name, unit_number, address, unit_bedrooms, unit_bathrooms, unit_size].hash
    end
