  ...
  class CreateAssociationRequest
    ...
    def self.openapi_types
      {
        ...
        :'address' => :'AssociationPostMessageAddress',
        :'is_active' => :'Boolean',
        :'reserve' => :'Float',
        :'description' => :'String',
        :'year_built' => :'Integer',
        :'property_manager_id' => :'Integer',
        :'tax_information' => :'AssociationPostMessageTaxInformation'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Buildium::CreateAssociationRequest` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Buildium::CreateAssociationRequest`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def hash
      [name, operating_bank_account_id, address, is_active, reserve, description, year_built, property_manager_id, tax_information].hash
    end
