...
module Buildium
  class EmailSearchMessage
    ...
    attr_accessor :sent_date_time_from
    ...
    attr_accessor :sent_date_time_to
    ...
    attr_accessor :recipient_name_or_email
    ...
    def self.attribute_map
      {
        :'sent_date_time_from' => :'SentDateTimeFrom',
        :'sent_date_time_to' => :'SentDateTimeTo',
        :'subject' => :'Subject',
        :'recipient_name_or_email' => :'RecipientNameOrEmail',
    ...
    def self.openapi_types
      {
        :'sent_date_time_from' => :'Time',
        :'sent_date_time_to' => :'Time',
        :'subject' => :'String',
        :'recipient_name_or_email' => :'String',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Buildium::EmailSearchMessage` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Buildium::EmailSearchMessage`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }

      if attributes.key?(:'sent_date_time_from')
        self.sent_date_time_from = attributes[:'sent_date_time_from']
      end

      if attributes.key?(:'sent_date_time_to')
        self.sent_date_time_to = attributes[:'sent_date_time_to']
      end
      ...
      if attributes.key?(:'recipient_name_or_email')
        self.recipient_name_or_email = attributes[:'recipient_name_or_email']
      end
    ...
    def list_invalid_properties
      ...
      if @sent_date_time_from.nil?
        invalid_properties.push('invalid value for "sent_date_time_from", sent_date_time_from cannot be nil.')
      end

      if @sent_date_time_to.nil?
        invalid_properties.push('invalid value for "sent_date_time_to", sent_date_time_to cannot be nil.')
      end
    ...
    def valid?
      return false if @sent_date_time_from.nil?
      return false if @sent_date_time_to.nil?
      true
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          sent_date_time_from == o.sent_date_time_from &&
          sent_date_time_to == o.sent_date_time_to &&
          subject == o.subject &&
          recipient_name_or_email == o.recipient_name_or_email &&
    ...
    def hash
      [sent_date_time_from, sent_date_time_to, subject, recipient_name_or_email, sender_user_id].hash
    end
