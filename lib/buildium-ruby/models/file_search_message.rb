...
module Buildium
  ...
  class FileSearchMessage
    ...
    attr_accessor :physical_file_names
    ...
    def self.attribute_map
      {
        ...
        :'title_or_description' => :'TitleOrDescription',
    ...
    def self.openapi_types
      {
        ...
        :'uploaded_from' => :'Date',
        :'uploaded_to' => :'Date',
        :'physical_file_names' => :'Array<String>'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Buildium::FileSearchMessage` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Buildium::FileSearchMessage`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'title_or_description')
        self.title_or_description = attributes[:'title_or_description']
      end

      if attributes.key?(:'uploaded_from')
        self.uploaded_from = attributes[:'uploaded_from']
      end

      if attributes.key?(:'uploaded_to')
        self.uploaded_to = attributes[:'uploaded_to']
      end

      if attributes.key?(:'physical_file_names')
        if (value = attributes[:'physical_file_names']).is_a?(Array)
          self.physical_file_names = value
        end
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          title_or_description == o.title_or_description &&
          uploaded_from == o.uploaded_from &&
          uploaded_to == o.uploaded_to &&
          physical_file_names == o.physical_file_names
    end
    ...
    def hash
      [entity_id, entity_type, category_id, title_or_description, uploaded_from, uploaded_to, physical_file_names].hash
    end
