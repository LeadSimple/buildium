...
module Buildium
  class GeneralJournalEntryLineSaveMessage
    # The general ledger account identifier under which the line item amount will be recorded. Query the General Ledger Account endpoint <a href=\"#operation/AccountingGetAllGLAccounts\">Get All GLAccounts</a> for a listing of available accounts.
