...
module Buildium
  ...
  class LeaseCosignerPostMessage
    ...
    def self.openapi_types
      {
        ...
        :'phone_numbers' => :'LeaseCosignerPostMessagePhoneNumbers',
        :'address' => :'LeaseCosignerPostMessageAddress',
        :'alternate_address' => :'LeaseCosignerPostMessageAlternateAddress',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Buildium::LeaseCosignerPostMessage` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Buildium::LeaseCosignerPostMessage`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def hash
      [first_name, last_name, email, alternate_email, phone_numbers, address, alternate_address, mailing_preference].hash
    end
