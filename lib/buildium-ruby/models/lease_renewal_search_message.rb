...
module Buildium
  # This object represents a filter for searching Lease Renewals.
  class LeaseRenewalSearchMessage
    ...
    attr_accessor :e_signature_statuses
    ...
    def self.attribute_map
      {
        ...
        :'e_signature_statuses' => :'ESignatureStatuses'
      }
    end
    ...
    def self.openapi_types
      {
        ...
        :'e_signature_statuses' => :'Array<String>'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Buildium::LeaseRenewalSearchMessage` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Buildium::LeaseRenewalSearchMessage`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'e_signature_statuses')
        if (value = attributes[:'e_signature_statuses']).is_a?(Array)
          self.e_signature_statuses = value
        end
      end
    end
    ...
    def list_invalid_properties
      ...
      if @e_signature_statuses.nil?
        invalid_properties.push('invalid value for "e_signature_statuses", e_signature_statuses cannot be nil.')
      end
    ...
    def valid?
      return false if @e_signature_statuses.nil?
      true
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          e_signature_statuses == o.e_signature_statuses
    end
    ...
    def hash
      [property_ids, rental_owner_ids, e_signature_statuses].hash
    end
