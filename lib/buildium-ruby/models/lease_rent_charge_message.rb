...
module Buildium
  class LeaseRentChargeMessage
    ...
    attr_accessor :due_on_day_of_the_month
    ...
    def self.attribute_map
      {
        ...
        :'due_on_day_of_the_month' => :'DueOnDayOfTheMonth'
      }
    end
    ...
    def self.openapi_types
      {
        ...
        :'due_on_day_of_the_month' => :'Integer'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Buildium::LeaseRentChargeMessage` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Buildium::LeaseRentChargeMessage`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'first_charge_date')
      ...
      if attributes.key?(:'due_on_day_of_the_month')
        self.due_on_day_of_the_month = attributes[:'due_on_day_of_the_month']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          due_on_day_of_the_month == o.due_on_day_of_the_month
    end
    ...
    def hash
      [id, gl_account_id, amount, memo, first_charge_date, post_days_in_advance, due_on_day_of_the_month].hash
    end
