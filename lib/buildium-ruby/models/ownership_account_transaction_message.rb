...
module Buildium
  ...
  class OwnershipAccountTransactionMessage
    ...
    attr_accessor :payee_association_owner_id
    ...
    def hash
      [id, date, transaction_type, transaction_type_enum, total_amount, check_number, ownership_account_id, payee_association_owner_id, payment_method, journal].hash
    end
