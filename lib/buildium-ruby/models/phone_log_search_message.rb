...
module Buildium
  class PhoneLogSearchMessage
    ...
    attr_accessor :logged_by_staff_user_ids
    ...
    attr_accessor :participant_entity_id
    ...
    attr_accessor :participant_entity_type
    ...
    attr_accessor :unit_agreement_type
    ...
    def self.attribute_map
      {
        :'from_date' => :'FromDate',
        :'to_date' => :'ToDate',
        :'logged_by_staff_user_ids' => :'LoggedByStaffUserIds',
        :'subject' => :'Subject',
        :'participant_entity_id' => :'ParticipantEntityId',
        :'participant_entity_type' => :'ParticipantEntityType',
        :'unit_agreement_id' => :'UnitAgreementId',
        :'unit_agreement_type' => :'UnitAgreementType'
      }
    end
    ...
    def self.openapi_types
      {
        :'from_date' => :'Date',
        :'to_date' => :'Date',
        :'logged_by_staff_user_ids' => :'Array<Integer>',
        :'subject' => :'String',
        :'participant_entity_id' => :'Integer',
        :'participant_entity_type' => :'String',
        :'unit_agreement_id' => :'Integer',
        :'unit_agreement_type' => :'String'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Buildium::PhoneLogSearchMessage` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Buildium::PhoneLogSearchMessage`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'logged_by_staff_user_ids')
        if (value = attributes[:'logged_by_staff_user_ids']).is_a?(Array)
          self.logged_by_staff_user_ids = value
        end
      end
      ...
      if attributes.key?(:'participant_entity_id')
        self.participant_entity_id = attributes[:'participant_entity_id']
      end

      if attributes.key?(:'participant_entity_type')
      ...
      if attributes.key?(:'unit_agreement_type')
        self.unit_agreement_type = attributes[:'unit_agreement_type']
      end
    end
    ...
    def valid?
      participant_entity_type_validator = EnumAttributeValidator.new('String', ["Vendor", "RentalOwner", "RentalTenant", "AssociationOwner"])
      return false unless participant_entity_type_validator.valid?(@participant_entity_type)
      unit_agreement_type_validator = EnumAttributeValidator.new('String', ["Lease", "OwnershipAccount"])
      return false unless unit_agreement_type_validator.valid?(@unit_agreement_type)
      true
    end

    # Custom attribute writer method checking allowed values (enum).
    # @param [Object] participant_entity_type Object to be assigned
    ...
    # Custom attribute writer method checking allowed values (enum).
    # @param [Object] unit_agreement_type Object to be assigned
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          to_date == o.to_date &&
          logged_by_staff_user_ids == o.logged_by_staff_user_ids &&
          subject == o.subject &&
          participant_entity_id == o.participant_entity_id &&
          participant_entity_type == o.participant_entity_type &&
          unit_agreement_id == o.unit_agreement_id &&
          unit_agreement_type == o.unit_agreement_type
    end
    ...
    def hash
      [from_date, to_date, logged_by_staff_user_ids, subject, participant_entity_id, participant_entity_type, unit_agreement_id, unit_agreement_type].hash
    end
