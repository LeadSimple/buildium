...
module Buildium
  class RentalOwnersSearchMessage
    ...
    attr_accessor :agreement_days_remaining
    ...
    def self.attribute_map
      {
        ...
        :'status' => :'Status',
        :'agreement_days_remaining' => :'AgreementDaysRemaining',
    ...
    def self.openapi_types
      {
        ...
        :'status' => :'String',
        :'agreement_days_remaining' => :'Integer',
        :'owner_name' => :'String',
        :'phone' => :'String',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Buildium::RentalOwnersSearchMessage` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Buildium::RentalOwnersSearchMessage`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'agreement_days_remaining')
        self.agreement_days_remaining = attributes[:'agreement_days_remaining']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          status == o.status &&
          agreement_days_remaining == o.agreement_days_remaining &&
    ...
    def hash
      [property_ids, status, agreement_days_remaining, owner_name, phone, last_updated_from, last_updated_to].hash
    end
