...
module Buildium
  class RentersInsurancePolicyMessage
    ...
    # @param [Object] carrier_type Object to be assigned
    def carrier_type=(carrier_type)
      validator = EnumAttributeValidator.new('String', ["Other", "MSI"])
      unless validator.valid?(carrier_type)
        fail ArgumentError, "invalid value #{ carrier_type.inspect } for \"carrier_type\", must be one of #{validator.allowable_values}."
      end
