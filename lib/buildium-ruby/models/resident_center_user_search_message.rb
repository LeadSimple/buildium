...
module Buildium
  class ResidentCenterUserSearchMessage
    ...
    attr_accessor :unit_agreement_ids
    ...
    attr_accessor :resident_center_user_statuses
    ...
    def self.attribute_map
      {
        :'unit_agreement_ids' => :'UnitAgreementIds',
        :'user_ids' => :'UserIds',
        :'user_types' => :'UserTypes',
        :'resident_center_user_statuses' => :'ResidentCenterUserStatuses',
    ...
    def self.openapi_types
      {
        :'unit_agreement_ids' => :'Array<Integer>',
        :'user_ids' => :'Array<Integer>',
        :'user_types' => :'Array<String>',
        :'resident_center_user_statuses' => :'Array<String>',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Buildium::ResidentCenterUserSearchMessage` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Buildium::ResidentCenterUserSearchMessage`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }

      if attributes.key?(:'unit_agreement_ids')
        if (value = attributes[:'unit_agreement_ids']).is_a?(Array)
          self.unit_agreement_ids = value
        end
      end
      ...
      if attributes.key?(:'user_types')
        if (value = attributes[:'user_types']).is_a?(Array)
          self.user_types = value
        end
      end

      if attributes.key?(:'resident_center_user_statuses')
        if (value = attributes[:'resident_center_user_statuses']).is_a?(Array)
          self.resident_center_user_statuses = value
        end
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          unit_agreement_ids == o.unit_agreement_ids &&
          user_ids == o.user_ids &&
          user_types == o.user_types &&
          resident_center_user_statuses == o.resident_center_user_statuses &&
    ...
    def hash
      [unit_agreement_ids, user_ids, user_types, resident_center_user_statuses, is_auto_pay_enabled].hash
    end
