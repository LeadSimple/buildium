...
module Buildium
  class ResidentRequestTaskPostMessage
    ...
    def hash
      [title, description, category_id, sub_category_id, unit_agreement_id, requested_by_entity_id, assigned_to_user_id, task_status, priority, due_date, is_entry_permitted_by_resident, does_resident_have_pets, resident_entry_notes].hash
    end
