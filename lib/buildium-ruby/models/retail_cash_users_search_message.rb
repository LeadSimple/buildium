...
module Buildium
  class RetailCashUsersSearchMessage
    ...
    def self.attribute_map
      {
        ...
        :'is_account_created' => :'IsAccountCreated'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Buildium::RetailCashUsersSearchMessage` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Buildium::RetailCashUsersSearchMessage`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'unit_address')
        self.unit_address = attributes[:'unit_address']
      end

      if attributes.key?(:'is_account_created')
        self.is_account_created = attributes[:'is_account_created']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          statuses == o.statuses &&
          name == o.name &&
          unit_address == o.unit_address &&
          is_account_created == o.is_account_created
    end
    ...
    def hash
      [entity_id, entity_type, statuses, name, unit_address, is_account_created].hash
    end
