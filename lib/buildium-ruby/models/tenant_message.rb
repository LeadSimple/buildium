...
module Buildium
  ...
  class TenantMessage
    ...
    attr_accessor :sms_opt_in_status
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Buildium::TenantMessage` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Buildium::TenantMessage`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'sms_opt_in_status')
        self.sms_opt_in_status = attributes[:'sms_opt_in_status']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          sms_opt_in_status == o.sms_opt_in_status &&
          address == o.address &&
    ...
    def hash
      [id, first_name, last_name, email, alternate_email, phone_numbers, created_date_time, emergency_contact, date_of_birth, sms_opt_in_status, address, alternate_address, mailing_preference, leases, comment, tax_id].hash
    end
