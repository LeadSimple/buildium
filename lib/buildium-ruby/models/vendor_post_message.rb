...
module Buildium
  class VendorPostMessage
    ...
    attr_accessor :expense_gl_account_id
    ...
    attr_accessor :vendor_insurance
    ...
    def self.openapi_types
      {
        ...
        :'comments' => :'String',
        :'tax_information' => :'VendorPostMessageTaxInformation'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Buildium::VendorPostMessage` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Buildium::VendorPostMessage`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'expense_gl_account_id')
        self.expense_gl_account_id = attributes[:'expense_gl_account_id']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          expense_gl_account_id == o.expense_gl_account_id &&
    ...
    def hash
      [first_name, last_name, is_company, company_name, primary_email, alternate_email, phone_numbers, address, category_id, expense_gl_account_id, account_number, website, vendor_insurance, comments, tax_information].hash
    end
