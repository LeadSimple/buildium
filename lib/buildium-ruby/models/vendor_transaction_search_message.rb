...
module Buildium
  class VendorTransactionSearchMessage
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Buildium::VendorTransactionSearchMessage` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Buildium::VendorTransactionSearchMessage`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def list_invalid_properties
      ...
      if @transaction_date_from.nil?
        invalid_properties.push('invalid value for "transaction_date_from", transaction_date_from cannot be nil.')
      end

      if @transaction_date_to.nil?
        invalid_properties.push('invalid value for "transaction_date_to", transaction_date_to cannot be nil.')
      end
    ...
    def valid?
      return false if @transaction_date_from.nil?
      return false if @transaction_date_to.nil?
      true
    end
    ...
    def hash
      [transaction_date_from, transaction_date_to, transaction_types, reference_number, memo].hash
    end
