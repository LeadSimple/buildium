...
module Buildium
  class TasksApi
    ...
    def create_upload_file_request_async(task_id, task_history_id, task_history_file_upload_post_message, opts = {})
      data, _status_code, _headers = create_upload_file_request_async_with_http_info(task_id, task_history_id, task_history_file_upload_post_message, opts)
      data
    end
    ...
    def create_upload_file_request_async_with_http_info(task_id, task_history_id, task_history_file_upload_post_message, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: TasksApi.create_upload_file_request_async ...'
      end
      # verify the required parameter 'task_id' is set
      if @api_client.config.client_side_validation && task_id.nil?
        fail ArgumentError, "Missing the required parameter 'task_id' when calling TasksApi.create_upload_file_request_async"
      end
      # verify the required parameter 'task_history_id' is set
      if @api_client.config.client_side_validation && task_history_id.nil?
        fail ArgumentError, "Missing the required parameter 'task_history_id' when calling TasksApi.create_upload_file_request_async"
      end
      ...
      if @api_client.config.client_side_validation && task_history_file_upload_post_message.nil?
        fail ArgumentError, "Missing the required parameter 'task_history_file_upload_post_message' when calling TasksApi.create_upload_file_request_async"
      end
      # resource path
      ...
      new_options = opts.merge(
        :operation => :"TasksApi.create_upload_file_request_async",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:POST, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: TasksApi#create_upload_file_request_async\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
