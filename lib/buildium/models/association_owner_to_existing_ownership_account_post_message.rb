...
module Buildium
  ...
  class AssociationOwnerToExistingOwnershipAccountPostMessage
    ...
    def hash
      [ownership_account_id, send_welcome_email, primary_address, alternate_address, first_name, last_name, board_member_term, is_owner_occupied, email, alternate_email, phone_numbers, date_of_birth, emergency_contact, comment, mailing_preference].hash
    end
