...
# Unit tests for Buildium::RentalOwnerRequestsApi
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'RentalOwnerRequestsApi' do
  before do
  ...
  describe 'test an instance of RentalOwnerRequestsApi' do
    it 'should create an instance of RentalOwnerRequestsApi' do
      expect(@api_instance).to be_instance_of(Buildium::RentalOwnerRequestsApi)
    end
  end
