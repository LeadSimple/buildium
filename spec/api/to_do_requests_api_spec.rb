...
# Unit tests for Buildium::ToDoRequestsApi
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'ToDoRequestsApi' do
  before do
  ...
  describe 'test an instance of ToDoRequestsApi' do
    it 'should create an instance of ToDoRequestsApi' do
      expect(@api_instance).to be_instance_of(Buildium::ToDoRequestsApi)
    end
  end
