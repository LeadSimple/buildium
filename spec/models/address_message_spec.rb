...
# Unit tests for Buildium::AddressMessage
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Buildium::AddressMessage do
  let(:instance) { Buildium::AddressMessage.new }

  describe 'test an instance of AddressMessage' do
    it 'should create an instance of AddressMessage' do
      expect(instance).to be_instance_of(Buildium::AddressMessage)
    end
  end
