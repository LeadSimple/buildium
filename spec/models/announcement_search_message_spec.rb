...
# Unit tests for Buildium::AnnouncementSearchMessage
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Buildium::AnnouncementSearchMessage do
  let(:instance) { Buildium::AnnouncementSearchMessage.new }

  describe 'test an instance of AnnouncementSearchMessage' do
    it 'should create an instance of AnnouncementSearchMessage' do
      expect(instance).to be_instance_of(Buildium::AnnouncementSearchMessage)
    end
  end
  describe 'test attribute "announcement_date_from"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "announcement_date_to"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
