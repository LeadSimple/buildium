...
# Unit tests for Buildium::ApplicantGroupPostMessage
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Buildium::ApplicantGroupPostMessage do
  let(:instance) { Buildium::ApplicantGroupPostMessage.new }

  describe 'test an instance of ApplicantGroupPostMessage' do
    it 'should create an instance of ApplicantGroupPostMessage' do
      expect(instance).to be_instance_of(Buildium::ApplicantGroupPostMessage)
    end
  end
