...
# Unit tests for Buildium::ApplicantSearchMessage
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Buildium::ApplicantSearchMessage do
  let(:instance) { Buildium::ApplicantSearchMessage.new }

  describe 'test an instance of ApplicantSearchMessage' do
    it 'should create an instance of ApplicantSearchMessage' do
      expect(instance).to be_instance_of(Buildium::ApplicantSearchMessage)
    end
  end
  ...
  describe 'test attribute "application_statuses"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
      ...
      # validator.allowable_values.each do |value|
      #   expect { instance.application_statuses = value }.not_to raise_error
      # end
    end
  end
  ...
  describe 'test attribute "application_submitted_start_date"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "application_submitted_end_date"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
