...
describe Buildium::ApplicationResponseMessage do
  ...
  describe 'test attribute "section_type"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["ApplicantInformation", "PropertyInformation", "RentalHistory", "Employment", "References", "Cosigners", "AdditionalOccupants", "Pets", "Vehicles", "TermsAndConditions", "Other", "CosignerInformation", "CosignerEmploymentHistory", "CosignerTermsAndConditions", "CosignerOther"])
