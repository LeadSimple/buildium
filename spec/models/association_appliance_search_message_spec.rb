...
# Unit tests for Buildium::AssociationApplianceSearchMessage
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Buildium::AssociationApplianceSearchMessage do
  let(:instance) { Buildium::AssociationApplianceSearchMessage.new }

  describe 'test an instance of AssociationApplianceSearchMessage' do
    it 'should create an instance of AssociationApplianceSearchMessage' do
      expect(instance).to be_instance_of(Buildium::AssociationApplianceSearchMessage)
    end
  end
