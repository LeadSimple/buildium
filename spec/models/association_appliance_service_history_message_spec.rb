...
# Unit tests for Buildium::AssociationApplianceServiceHistoryMessage
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Buildium::AssociationApplianceServiceHistoryMessage do
  let(:instance) { Buildium::AssociationApplianceServiceHistoryMessage.new }

  describe 'test an instance of AssociationApplianceServiceHistoryMessage' do
    it 'should create an instance of AssociationApplianceServiceHistoryMessage' do
      expect(instance).to be_instance_of(Buildium::AssociationApplianceServiceHistoryMessage)
    end
  end
