...
# Unit tests for Buildium::AssociationBoardMemberMessage
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Buildium::AssociationBoardMemberMessage do
  let(:instance) { Buildium::AssociationBoardMemberMessage.new }

  describe 'test an instance of AssociationBoardMemberMessage' do
    it 'should create an instance of AssociationBoardMemberMessage' do
      expect(instance).to be_instance_of(Buildium::AssociationBoardMemberMessage)
    end
  end
