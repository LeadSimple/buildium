...
# Unit tests for Buildium::AssociationBoardMemberPutMessage
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Buildium::AssociationBoardMemberPutMessage do
  let(:instance) { Buildium::AssociationBoardMemberPutMessage.new }

  describe 'test an instance of AssociationBoardMemberPutMessage' do
    it 'should create an instance of AssociationBoardMemberPutMessage' do
      expect(instance).to be_instance_of(Buildium::AssociationBoardMemberPutMessage)
    end
  end
