...
# Unit tests for Buildium::AssociationPreferredVendorMessage
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Buildium::AssociationPreferredVendorMessage do
  let(:instance) { Buildium::AssociationPreferredVendorMessage.new }

  describe 'test an instance of AssociationPreferredVendorMessage' do
    it 'should create an instance of AssociationPreferredVendorMessage' do
      expect(instance).to be_instance_of(Buildium::AssociationPreferredVendorMessage)
    end
  end
