...
# Unit tests for Buildium::AssociationUnitMessage
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Buildium::AssociationUnitMessage do
  let(:instance) { Buildium::AssociationUnitMessage.new }

  describe 'test an instance of AssociationUnitMessage' do
    it 'should create an instance of AssociationUnitMessage' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Buildium::AssociationUnitMessage)
    end
  end
