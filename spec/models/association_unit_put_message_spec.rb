...
# Unit tests for Buildium::AssociationUnitPutMessage
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Buildium::AssociationUnitPutMessage do
  let(:instance) { Buildium::AssociationUnitPutMessage.new }

  describe 'test an instance of AssociationUnitPutMessage' do
    it 'should create an instance of AssociationUnitPutMessage' do
      expect(instance).to be_instance_of(Buildium::AssociationUnitPutMessage)
    end
  end
