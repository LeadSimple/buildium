...
# Unit tests for Buildium::AssociationUnitsPostMessage
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Buildium::AssociationUnitsPostMessage do
  let(:instance) { Buildium::AssociationUnitsPostMessage.new }

  describe 'test an instance of AssociationUnitsPostMessage' do
    it 'should create an instance of AssociationUnitsPostMessage' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Buildium::AssociationUnitsPostMessage)
    end
  end
