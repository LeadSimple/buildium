...
# Unit tests for Buildium::BankAccountCheckAccountingEntitySaveMessage
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Buildium::BankAccountCheckAccountingEntitySaveMessage do
  let(:instance) { Buildium::BankAccountCheckAccountingEntitySaveMessage.new }

  describe 'test an instance of BankAccountCheckAccountingEntitySaveMessage' do
    it 'should create an instance of BankAccountCheckAccountingEntitySaveMessage' do
      expect(instance).to be_instance_of(Buildium::BankAccountCheckAccountingEntitySaveMessage)
    end
  end
