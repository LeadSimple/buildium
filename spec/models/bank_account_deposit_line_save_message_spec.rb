...
# Unit tests for Buildium::BankAccountDepositLineSaveMessage
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Buildium::BankAccountDepositLineSaveMessage do
  let(:instance) { Buildium::BankAccountDepositLineSaveMessage.new }

  describe 'test an instance of BankAccountDepositLineSaveMessage' do
    it 'should create an instance of BankAccountDepositLineSaveMessage' do
      expect(instance).to be_instance_of(Buildium::BankAccountDepositLineSaveMessage)
    end
  end
