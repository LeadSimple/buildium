...
# Unit tests for Buildium::BankAccountDepositPostMessage
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Buildium::BankAccountDepositPostMessage do
  let(:instance) { Buildium::BankAccountDepositPostMessage.new }

  describe 'test an instance of BankAccountDepositPostMessage' do
    it 'should create an instance of BankAccountDepositPostMessage' do
      expect(instance).to be_instance_of(Buildium::BankAccountDepositPostMessage)
    end
  end
  ...
  describe 'test attribute "payment_transaction_ids"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
