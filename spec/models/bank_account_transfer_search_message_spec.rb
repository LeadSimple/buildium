...
# Unit tests for Buildium::BankAccountTransferSearchMessage
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Buildium::BankAccountTransferSearchMessage do
  let(:instance) { Buildium::BankAccountTransferSearchMessage.new }

  describe 'test an instance of BankAccountTransferSearchMessage' do
    it 'should create an instance of BankAccountTransferSearchMessage' do
      expect(instance).to be_instance_of(Buildium::BankAccountTransferSearchMessage)
    end
  end
