...
# Unit tests for Buildium::BankLockboxDataAssociationMessage
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Buildium::BankLockboxDataAssociationMessage do
  let(:instance) { Buildium::BankLockboxDataAssociationMessage.new }

  describe 'test an instance of BankLockboxDataAssociationMessage' do
    it 'should create an instance of BankLockboxDataAssociationMessage' do
      expect(instance).to be_instance_of(Buildium::BankLockboxDataAssociationMessage)
    end
  end
