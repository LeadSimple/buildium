...
# Unit tests for Buildium::BankLockboxDataMessage
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Buildium::BankLockboxDataMessage do
  let(:instance) { Buildium::BankLockboxDataMessage.new }

  describe 'test an instance of BankLockboxDataMessage' do
    it 'should create an instance of BankLockboxDataMessage' do
      expect(instance).to be_instance_of(Buildium::BankLockboxDataMessage)
    end
  end
