...
# Unit tests for Buildium::BillLinePostMessage
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Buildium::BillLinePostMessage do
  let(:instance) { Buildium::BillLinePostMessage.new }

  describe 'test an instance of BillLinePostMessage' do
    it 'should create an instance of BillLinePostMessage' do
      expect(instance).to be_instance_of(Buildium::BillLinePostMessage)
    end
  end
