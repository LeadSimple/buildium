...
# Unit tests for Buildium::BillPaymentPostMessage
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Buildium::BillPaymentPostMessage do
  let(:instance) { Buildium::BillPaymentPostMessage.new }

  describe 'test an instance of BillPaymentPostMessage' do
    it 'should create an instance of BillPaymentPostMessage' do
      expect(instance).to be_instance_of(Buildium::BillPaymentPostMessage)
    end
  end
