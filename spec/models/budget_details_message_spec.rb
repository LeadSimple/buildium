...
# Unit tests for Buildium::BudgetDetailsMessage
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Buildium::BudgetDetailsMessage do
  let(:instance) { Buildium::BudgetDetailsMessage.new }

  describe 'test an instance of BudgetDetailsMessage' do
    it 'should create an instance of BudgetDetailsMessage' do
      expect(instance).to be_instance_of(Buildium::BudgetDetailsMessage)
    end
  end
  ...
  describe 'test attribute "gl_account_sub_type"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
      ...
      #   expect { instance.gl_account_sub_type = value }.not_to raise_error
      # end
    end
  end
