...
# Unit tests for Buildium::BudgetPutMessage
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Buildium::BudgetPutMessage do
  let(:instance) { Buildium::BudgetPutMessage.new }

  describe 'test an instance of BudgetPutMessage' do
    it 'should create an instance of BudgetPutMessage' do
      expect(instance).to be_instance_of(Buildium::BudgetPutMessage)
    end
  end
