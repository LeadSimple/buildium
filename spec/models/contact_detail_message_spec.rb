...
# Unit tests for Buildium::ContactDetailMessage
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Buildium::ContactDetailMessage do
  let(:instance) { Buildium::ContactDetailMessage.new }

  describe 'test an instance of ContactDetailMessage' do
    it 'should create an instance of ContactDetailMessage' do
      expect(instance).to be_instance_of(Buildium::ContactDetailMessage)
    end
  end
