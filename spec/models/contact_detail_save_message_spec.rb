...
# Unit tests for Buildium::ContactDetailSaveMessage
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Buildium::ContactDetailSaveMessage do
  let(:instance) { Buildium::ContactDetailSaveMessage.new }

  describe 'test an instance of ContactDetailSaveMessage' do
    it 'should create an instance of ContactDetailSaveMessage' do
      expect(instance).to be_instance_of(Buildium::ContactDetailSaveMessage)
    end
  end
