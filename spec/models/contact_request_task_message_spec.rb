...
# Unit tests for Buildium::ContactRequestTaskMessage
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Buildium::ContactRequestTaskMessage do
  let(:instance) { Buildium::ContactRequestTaskMessage.new }

  describe 'test an instance of ContactRequestTaskMessage' do
    it 'should create an instance of ContactRequestTaskMessage' do
      expect(instance).to be_instance_of(Buildium::ContactRequestTaskMessage)
    end
  end
