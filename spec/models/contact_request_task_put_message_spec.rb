...
# Unit tests for Buildium::ContactRequestTaskPutMessage
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Buildium::ContactRequestTaskPutMessage do
  let(:instance) { Buildium::ContactRequestTaskPutMessage.new }

  describe 'test an instance of ContactRequestTaskPutMessage' do
    it 'should create an instance of ContactRequestTaskPutMessage' do
      expect(instance).to be_instance_of(Buildium::ContactRequestTaskPutMessage)
    end
  end
