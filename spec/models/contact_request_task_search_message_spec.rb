...
# Unit tests for Buildium::ContactRequestTaskSearchMessage
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Buildium::ContactRequestTaskSearchMessage do
  let(:instance) { Buildium::ContactRequestTaskSearchMessage.new }

  describe 'test an instance of ContactRequestTaskSearchMessage' do
    it 'should create an instance of ContactRequestTaskSearchMessage' do
      expect(instance).to be_instance_of(Buildium::ContactRequestTaskSearchMessage)
    end
  end
