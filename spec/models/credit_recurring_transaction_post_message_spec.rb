...
# Unit tests for Buildium::CreditRecurringTransactionPostMessage
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Buildium::CreditRecurringTransactionPostMessage do
  let(:instance) { Buildium::CreditRecurringTransactionPostMessage.new }

  describe 'test an instance of CreditRecurringTransactionPostMessage' do
    it 'should create an instance of CreditRecurringTransactionPostMessage' do
      expect(instance).to be_instance_of(Buildium::CreditRecurringTransactionPostMessage)
    end
  end
