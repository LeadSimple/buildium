...
# Unit tests for Buildium::DepositDetailMessage
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Buildium::DepositDetailMessage do
  let(:instance) { Buildium::DepositDetailMessage.new }

  describe 'test an instance of DepositDetailMessage' do
    it 'should create an instance of DepositDetailMessage' do
      expect(instance).to be_instance_of(Buildium::DepositDetailMessage)
    end
  end
  ...
  describe 'test attribute "payment_transactions"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
