...
# Unit tests for Buildium::EmailRecipientMessage
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Buildium::EmailRecipientMessage do
  let(:instance) { Buildium::EmailRecipientMessage.new }

  describe 'test an instance of EmailRecipientMessage' do
    it 'should create an instance of EmailRecipientMessage' do
      expect(instance).to be_instance_of(Buildium::EmailRecipientMessage)
    end
  end
  ...
  describe 'test attribute "recipient_type"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["Tenant", "AssociationOwner", "RentalOwner", "AssociationTenant", "Applicant", "Vendor", "Staff"])
