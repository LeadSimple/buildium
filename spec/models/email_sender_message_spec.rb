...
# Unit tests for Buildium::EmailSenderMessage
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Buildium::EmailSenderMessage do
  let(:instance) { Buildium::EmailSenderMessage.new }

  describe 'test an instance of EmailSenderMessage' do
    it 'should create an instance of EmailSenderMessage' do
      expect(instance).to be_instance_of(Buildium::EmailSenderMessage)
    end
  end
