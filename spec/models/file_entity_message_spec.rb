...
# Unit tests for Buildium::FileEntityMessage
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Buildium::FileEntityMessage do
  let(:instance) { Buildium::FileEntityMessage.new }

  describe 'test an instance of FileEntityMessage' do
    it 'should create an instance of FileEntityMessage' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Buildium::FileEntityMessage)
    end
  end
