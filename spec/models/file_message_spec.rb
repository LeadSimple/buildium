...
# Unit tests for Buildium::FileMessage
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Buildium::FileMessage do
  let(:instance) { Buildium::FileMessage.new }

  describe 'test an instance of FileMessage' do
    it 'should create an instance of FileMessage' do
      expect(instance).to be_instance_of(Buildium::FileMessage)
    end
  end
  ...
  describe 'test attribute "file_entity"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
