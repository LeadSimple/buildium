...
# Unit tests for Buildium::GeneralJournalEntryLineSaveMessage
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Buildium::GeneralJournalEntryLineSaveMessage do
  let(:instance) { Buildium::GeneralJournalEntryLineSaveMessage.new }

  describe 'test an instance of GeneralJournalEntryLineSaveMessage' do
    it 'should create an instance of GeneralJournalEntryLineSaveMessage' do
      expect(instance).to be_instance_of(Buildium::GeneralJournalEntryLineSaveMessage)
    end
  end
  ...
  describe 'test attribute "posting_type"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["Credit", "Debit"])
      # validator.allowable_values.each do |value|
      #   expect { instance.posting_type = value }.not_to raise_error
      # end
    end
  end
