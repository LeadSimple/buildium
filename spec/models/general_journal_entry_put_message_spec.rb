...
# Unit tests for Buildium::GeneralJournalEntryPutMessage
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Buildium::GeneralJournalEntryPutMessage do
  let(:instance) { Buildium::GeneralJournalEntryPutMessage.new }

  describe 'test an instance of GeneralJournalEntryPutMessage' do
    it 'should create an instance of GeneralJournalEntryPutMessage' do
      expect(instance).to be_instance_of(Buildium::GeneralJournalEntryPutMessage)
    end
  end
