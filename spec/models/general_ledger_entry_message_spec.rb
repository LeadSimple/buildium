...
# Unit tests for Buildium::GeneralLedgerEntryMessage
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Buildium::GeneralLedgerEntryMessage do
  let(:instance) { Buildium::GeneralLedgerEntryMessage.new }

  describe 'test an instance of GeneralLedgerEntryMessage' do
    it 'should create an instance of GeneralLedgerEntryMessage' do
      expect(instance).to be_instance_of(Buildium::GeneralLedgerEntryMessage)
    end
  end
