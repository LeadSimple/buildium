...
# Unit tests for Buildium::GeneralLedgerJournalMessage
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Buildium::GeneralLedgerJournalMessage do
  let(:instance) { Buildium::GeneralLedgerJournalMessage.new }

  describe 'test an instance of GeneralLedgerJournalMessage' do
    it 'should create an instance of GeneralLedgerJournalMessage' do
      expect(instance).to be_instance_of(Buildium::GeneralLedgerJournalMessage)
    end
  end
