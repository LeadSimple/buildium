...
# Unit tests for Buildium::GeneralLedgerSearchMessage
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Buildium::GeneralLedgerSearchMessage do
  let(:instance) { Buildium::GeneralLedgerSearchMessage.new }

  describe 'test an instance of GeneralLedgerSearchMessage' do
    it 'should create an instance of GeneralLedgerSearchMessage' do
      expect(instance).to be_instance_of(Buildium::GeneralLedgerSearchMessage)
    end
  end
