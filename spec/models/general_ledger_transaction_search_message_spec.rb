...
# Unit tests for Buildium::GeneralLedgerTransactionSearchMessage
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Buildium::GeneralLedgerTransactionSearchMessage do
  let(:instance) { Buildium::GeneralLedgerTransactionSearchMessage.new }

  describe 'test an instance of GeneralLedgerTransactionSearchMessage' do
    it 'should create an instance of GeneralLedgerTransactionSearchMessage' do
      expect(instance).to be_instance_of(Buildium::GeneralLedgerTransactionSearchMessage)
    end
  end
