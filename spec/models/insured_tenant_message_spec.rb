...
# Unit tests for Buildium::InsuredTenantMessage
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Buildium::InsuredTenantMessage do
  let(:instance) { Buildium::InsuredTenantMessage.new }

  describe 'test an instance of InsuredTenantMessage' do
    it 'should create an instance of InsuredTenantMessage' do
      expect(instance).to be_instance_of(Buildium::InsuredTenantMessage)
    end
  end
  ...
  describe 'test attribute "is_primary_insured"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
