...
# Unit tests for Buildium::LeaseAccountDetailMessage
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Buildium::LeaseAccountDetailMessage do
  let(:instance) { Buildium::LeaseAccountDetailMessage.new }

  describe 'test an instance of LeaseAccountDetailMessage' do
    it 'should create an instance of LeaseAccountDetailMessage' do
      expect(instance).to be_instance_of(Buildium::LeaseAccountDetailMessage)
    end
  end
