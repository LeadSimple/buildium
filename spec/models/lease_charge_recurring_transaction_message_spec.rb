...
# Unit tests for Buildium::LeaseChargeRecurringTransactionMessage
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Buildium::LeaseChargeRecurringTransactionMessage do
  let(:instance) { Buildium::LeaseChargeRecurringTransactionMessage.new }

  describe 'test an instance of LeaseChargeRecurringTransactionMessage' do
    it 'should create an instance of LeaseChargeRecurringTransactionMessage' do
      expect(instance).to be_instance_of(Buildium::LeaseChargeRecurringTransactionMessage)
    end
  end
