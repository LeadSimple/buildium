...
# Unit tests for Buildium::LeaseLedgerCreditPostMessage
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Buildium::LeaseLedgerCreditPostMessage do
  let(:instance) { Buildium::LeaseLedgerCreditPostMessage.new }

  describe 'test an instance of LeaseLedgerCreditPostMessage' do
    it 'should create an instance of LeaseLedgerCreditPostMessage' do
      expect(instance).to be_instance_of(Buildium::LeaseLedgerCreditPostMessage)
    end
  end
