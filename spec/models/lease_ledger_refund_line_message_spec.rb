...
# Unit tests for Buildium::LeaseLedgerRefundLineMessage
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Buildium::LeaseLedgerRefundLineMessage do
  let(:instance) { Buildium::LeaseLedgerRefundLineMessage.new }

  describe 'test an instance of LeaseLedgerRefundLineMessage' do
    it 'should create an instance of LeaseLedgerRefundLineMessage' do
      expect(instance).to be_instance_of(Buildium::LeaseLedgerRefundLineMessage)
    end
  end
