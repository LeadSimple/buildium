...
# Unit tests for Buildium::LeaseLedgerRefundLinePostMessage
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Buildium::LeaseLedgerRefundLinePostMessage do
  let(:instance) { Buildium::LeaseLedgerRefundLinePostMessage.new }

  describe 'test an instance of LeaseLedgerRefundLinePostMessage' do
    it 'should create an instance of LeaseLedgerRefundLinePostMessage' do
      expect(instance).to be_instance_of(Buildium::LeaseLedgerRefundLinePostMessage)
    end
  end
