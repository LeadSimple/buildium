...
# Unit tests for Buildium::LeaseMoveOutDataMessage
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Buildium::LeaseMoveOutDataMessage do
  let(:instance) { Buildium::LeaseMoveOutDataMessage.new }

  describe 'test an instance of LeaseMoveOutDataMessage' do
    it 'should create an instance of LeaseMoveOutDataMessage' do
      expect(instance).to be_instance_of(Buildium::LeaseMoveOutDataMessage)
    end
  end
