...
# Unit tests for Buildium::LeaseMoveOutDataPostMessage
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Buildium::LeaseMoveOutDataPostMessage do
  let(:instance) { Buildium::LeaseMoveOutDataPostMessage.new }

  describe 'test an instance of LeaseMoveOutDataPostMessage' do
    it 'should create an instance of LeaseMoveOutDataPostMessage' do
      expect(instance).to be_instance_of(Buildium::LeaseMoveOutDataPostMessage)
    end
  end
