...
# Unit tests for Buildium::LeaseRecurringCreditMessage
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Buildium::LeaseRecurringCreditMessage do
  let(:instance) { Buildium::LeaseRecurringCreditMessage.new }

  describe 'test an instance of LeaseRecurringCreditMessage' do
    it 'should create an instance of LeaseRecurringCreditMessage' do
      expect(instance).to be_instance_of(Buildium::LeaseRecurringCreditMessage)
    end
  end
