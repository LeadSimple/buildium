...
# Unit tests for Buildium::LeaseRenewalSearchMessage
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Buildium::LeaseRenewalSearchMessage do
  let(:instance) { Buildium::LeaseRenewalSearchMessage.new }

  describe 'test an instance of LeaseRenewalSearchMessage' do
    it 'should create an instance of LeaseRenewalSearchMessage' do
      expect(instance).to be_instance_of(Buildium::LeaseRenewalSearchMessage)
    end
  end
  ...
  describe 'test attribute "e_signature_statuses"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('Array<String>', ["Unknown", "NotSent", "ProcessingRequest", "AwaitingSignatures", "FullySigned", "PendingCancellation", "Cancelled", "Failed", "SentUsingAdobe"])
      # validator.allowable_values.each do |value|
      #   expect { instance.e_signature_statuses = value }.not_to raise_error
      # end
    end
  end
