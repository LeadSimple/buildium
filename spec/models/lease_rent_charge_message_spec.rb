...
# Unit tests for Buildium::LeaseRentChargeMessage
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Buildium::LeaseRentChargeMessage do
  let(:instance) { Buildium::LeaseRentChargeMessage.new }

  describe 'test an instance of LeaseRentChargeMessage' do
    it 'should create an instance of LeaseRentChargeMessage' do
      expect(instance).to be_instance_of(Buildium::LeaseRentChargeMessage)
    end
  end
  ...
  describe 'test attribute "due_on_day_of_the_month"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
