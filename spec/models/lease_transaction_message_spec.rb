...
# Unit tests for Buildium::LeaseTransactionMessage
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Buildium::LeaseTransactionMessage do
  let(:instance) { Buildium::LeaseTransactionMessage.new }

  describe 'test an instance of LeaseTransactionMessage' do
    it 'should create an instance of LeaseTransactionMessage' do
      expect(instance).to be_instance_of(Buildium::LeaseTransactionMessage)
    end
  end
  ...
  describe 'test attribute "payee_tenant_id"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
