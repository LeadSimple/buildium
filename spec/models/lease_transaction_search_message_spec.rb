...
# Unit tests for Buildium::LeaseTransactionSearchMessage
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Buildium::LeaseTransactionSearchMessage do
  let(:instance) { Buildium::LeaseTransactionSearchMessage.new }

  describe 'test an instance of LeaseTransactionSearchMessage' do
    it 'should create an instance of LeaseTransactionSearchMessage' do
      expect(instance).to be_instance_of(Buildium::LeaseTransactionSearchMessage)
    end
  end
