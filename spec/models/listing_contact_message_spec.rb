...
# Unit tests for Buildium::ListingContactMessage
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Buildium::ListingContactMessage do
  let(:instance) { Buildium::ListingContactMessage.new }

  describe 'test an instance of ListingContactMessage' do
    it 'should create an instance of ListingContactMessage' do
      expect(instance).to be_instance_of(Buildium::ListingContactMessage)
    end
  end
