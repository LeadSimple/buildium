...
# Unit tests for Buildium::ListingPropertyMessage
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Buildium::ListingPropertyMessage do
  let(:instance) { Buildium::ListingPropertyMessage.new }

  describe 'test an instance of ListingPropertyMessage' do
    it 'should create an instance of ListingPropertyMessage' do
      expect(instance).to be_instance_of(Buildium::ListingPropertyMessage)
    end
  end
