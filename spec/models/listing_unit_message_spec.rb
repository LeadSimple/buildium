...
# Unit tests for Buildium::ListingUnitMessage
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Buildium::ListingUnitMessage do
  let(:instance) { Buildium::ListingUnitMessage.new }

  describe 'test an instance of ListingUnitMessage' do
    it 'should create an instance of ListingUnitMessage' do
      expect(instance).to be_instance_of(Buildium::ListingUnitMessage)
    end
  end
