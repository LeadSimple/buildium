...
# Unit tests for Buildium::NoteSearchMessage
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Buildium::NoteSearchMessage do
  let(:instance) { Buildium::NoteSearchMessage.new }

  describe 'test an instance of NoteSearchMessage' do
    it 'should create an instance of NoteSearchMessage' do
      expect(instance).to be_instance_of(Buildium::NoteSearchMessage)
    end
  end
  describe 'test attribute "updated_date_time_from"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "updated_date_time_to"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
