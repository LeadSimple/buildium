...
# Unit tests for Buildium::OfflinePaymentsMessage
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Buildium::OfflinePaymentsMessage do
  let(:instance) { Buildium::OfflinePaymentsMessage.new }

  describe 'test an instance of OfflinePaymentsMessage' do
    it 'should create an instance of OfflinePaymentsMessage' do
      expect(instance).to be_instance_of(Buildium::OfflinePaymentsMessage)
    end
  end
