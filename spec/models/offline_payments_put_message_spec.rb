...
# Unit tests for Buildium::OfflinePaymentsPutMessage
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Buildium::OfflinePaymentsPutMessage do
  let(:instance) { Buildium::OfflinePaymentsPutMessage.new }

  describe 'test an instance of OfflinePaymentsPutMessage' do
    it 'should create an instance of OfflinePaymentsPutMessage' do
      expect(instance).to be_instance_of(Buildium::OfflinePaymentsPutMessage)
    end
  end
  describe 'test attribute "display_info_in_resident_center"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "display_company_address"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
