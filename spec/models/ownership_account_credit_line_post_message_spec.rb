...
# Unit tests for Buildium::OwnershipAccountCreditLinePostMessage
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Buildium::OwnershipAccountCreditLinePostMessage do
  let(:instance) { Buildium::OwnershipAccountCreditLinePostMessage.new }

  describe 'test an instance of OwnershipAccountCreditLinePostMessage' do
    it 'should create an instance of OwnershipAccountCreditLinePostMessage' do
      expect(instance).to be_instance_of(Buildium::OwnershipAccountCreditLinePostMessage)
    end
  end
