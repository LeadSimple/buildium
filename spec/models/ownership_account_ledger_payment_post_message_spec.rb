...
# Unit tests for Buildium::OwnershipAccountLedgerPaymentPostMessage
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Buildium::OwnershipAccountLedgerPaymentPostMessage do
  let(:instance) { Buildium::OwnershipAccountLedgerPaymentPostMessage.new }

  describe 'test an instance of OwnershipAccountLedgerPaymentPostMessage' do
    it 'should create an instance of OwnershipAccountLedgerPaymentPostMessage' do
      expect(instance).to be_instance_of(Buildium::OwnershipAccountLedgerPaymentPostMessage)
    end
  end
