...
# Unit tests for Buildium::OwnershipAccountRecurringPaymentMessage
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Buildium::OwnershipAccountRecurringPaymentMessage do
  let(:instance) { Buildium::OwnershipAccountRecurringPaymentMessage.new }

  describe 'test an instance of OwnershipAccountRecurringPaymentMessage' do
    it 'should create an instance of OwnershipAccountRecurringPaymentMessage' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Buildium::OwnershipAccountRecurringPaymentMessage)
    end
  end
