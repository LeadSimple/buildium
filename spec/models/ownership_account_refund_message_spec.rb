...
# Unit tests for Buildium::OwnershipAccountRefundMessage
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Buildium::OwnershipAccountRefundMessage do
  let(:instance) { Buildium::OwnershipAccountRefundMessage.new }

  describe 'test an instance of OwnershipAccountRefundMessage' do
    it 'should create an instance of OwnershipAccountRefundMessage' do
      expect(instance).to be_instance_of(Buildium::OwnershipAccountRefundMessage)
    end
  end
