...
# Unit tests for Buildium::OwnershipAccountRefundPostMessage
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Buildium::OwnershipAccountRefundPostMessage do
  let(:instance) { Buildium::OwnershipAccountRefundPostMessage.new }

  describe 'test an instance of OwnershipAccountRefundPostMessage' do
    it 'should create an instance of OwnershipAccountRefundPostMessage' do
      expect(instance).to be_instance_of(Buildium::OwnershipAccountRefundPostMessage)
    end
  end
  ...
  describe 'test attribute "payee_user_ids"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
