...
# Unit tests for Buildium::OwnershipAccountTransactionMessage
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Buildium::OwnershipAccountTransactionMessage do
  let(:instance) { Buildium::OwnershipAccountTransactionMessage.new }

  describe 'test an instance of OwnershipAccountTransactionMessage' do
    it 'should create an instance of OwnershipAccountTransactionMessage' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Buildium::OwnershipAccountTransactionMessage)
    end
  end
  ...
  describe 'test attribute "transaction_type_enum"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
      ...
      #   expect { instance.transaction_type_enum = value }.not_to raise_error
      # end
    end
  end
  ...
  describe 'test attribute "payee_association_owner_id"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
