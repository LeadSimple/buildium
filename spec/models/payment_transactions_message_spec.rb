...
# Unit tests for Buildium::PaymentTransactionsMessage
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Buildium::PaymentTransactionsMessage do
  let(:instance) { Buildium::PaymentTransactionsMessage.new }

  describe 'test an instance of PaymentTransactionsMessage' do
    it 'should create an instance of PaymentTransactionsMessage' do
      expect(instance).to be_instance_of(Buildium::PaymentTransactionsMessage)
    end
  end
