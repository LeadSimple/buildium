...
# Unit tests for Buildium::PhoneLogParticipantUnitAgreementPostMessage
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Buildium::PhoneLogParticipantUnitAgreementPostMessage do
  let(:instance) { Buildium::PhoneLogParticipantUnitAgreementPostMessage.new }

  describe 'test an instance of PhoneLogParticipantUnitAgreementPostMessage' do
    it 'should create an instance of PhoneLogParticipantUnitAgreementPostMessage' do
      expect(instance).to be_instance_of(Buildium::PhoneLogParticipantUnitAgreementPostMessage)
    end
  end
  ...
  describe 'test attribute "type"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["NotSet", "Lease", "OwnershipAccount"])
