...
# Unit tests for Buildium::PhoneNumbersMessage
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Buildium::PhoneNumbersMessage do
  let(:instance) { Buildium::PhoneNumbersMessage.new }

  describe 'test an instance of PhoneNumbersMessage' do
    it 'should create an instance of PhoneNumbersMessage' do
      expect(instance).to be_instance_of(Buildium::PhoneNumbersMessage)
    end
  end
