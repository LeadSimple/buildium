...
# Unit tests for Buildium::PropertyGroupPostMessage
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Buildium::PropertyGroupPostMessage do
  let(:instance) { Buildium::PropertyGroupPostMessage.new }

  describe 'test an instance of PropertyGroupPostMessage' do
    it 'should create an instance of PropertyGroupPostMessage' do
      expect(instance).to be_instance_of(Buildium::PropertyGroupPostMessage)
    end
  end
