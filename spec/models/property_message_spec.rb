...
# Unit tests for Buildium::PropertyMessage
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Buildium::PropertyMessage do
  let(:instance) { Buildium::PropertyMessage.new }

  describe 'test an instance of PropertyMessage' do
    it 'should create an instance of PropertyMessage' do
      expect(instance).to be_instance_of(Buildium::PropertyMessage)
    end
  end
