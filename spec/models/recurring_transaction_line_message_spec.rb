...
# Unit tests for Buildium::RecurringTransactionLineMessage
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Buildium::RecurringTransactionLineMessage do
  let(:instance) { Buildium::RecurringTransactionLineMessage.new }

  describe 'test an instance of RecurringTransactionLineMessage' do
    it 'should create an instance of RecurringTransactionLineMessage' do
      expect(instance).to be_instance_of(Buildium::RecurringTransactionLineMessage)
    end
  end
