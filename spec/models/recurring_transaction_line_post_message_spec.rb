...
# Unit tests for Buildium::RecurringTransactionLinePostMessage
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Buildium::RecurringTransactionLinePostMessage do
  let(:instance) { Buildium::RecurringTransactionLinePostMessage.new }

  describe 'test an instance of RecurringTransactionLinePostMessage' do
    it 'should create an instance of RecurringTransactionLinePostMessage' do
      expect(instance).to be_instance_of(Buildium::RecurringTransactionLinePostMessage)
    end
  end
