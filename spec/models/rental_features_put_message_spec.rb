...
# Unit tests for Buildium::RentalFeaturesPutMessage
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Buildium::RentalFeaturesPutMessage do
  let(:instance) { Buildium::RentalFeaturesPutMessage.new }

  describe 'test an instance of RentalFeaturesPutMessage' do
    it 'should create an instance of RentalFeaturesPutMessage' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Buildium::RentalFeaturesPutMessage)
    end
  end
