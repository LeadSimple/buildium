...
# Unit tests for Buildium::RentalOwnerContributionDataMessage
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Buildium::RentalOwnerContributionDataMessage do
  let(:instance) { Buildium::RentalOwnerContributionDataMessage.new }

  describe 'test an instance of RentalOwnerContributionDataMessage' do
    it 'should create an instance of RentalOwnerContributionDataMessage' do
      expect(instance).to be_instance_of(Buildium::RentalOwnerContributionDataMessage)
    end
  end
