...
# Unit tests for Buildium::RentalOwnerContributionPutMessage
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Buildium::RentalOwnerContributionPutMessage do
  let(:instance) { Buildium::RentalOwnerContributionPutMessage.new }

  describe 'test an instance of RentalOwnerContributionPutMessage' do
    it 'should create an instance of RentalOwnerContributionPutMessage' do
      expect(instance).to be_instance_of(Buildium::RentalOwnerContributionPutMessage)
    end
  end
