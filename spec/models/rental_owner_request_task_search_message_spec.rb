...
# Unit tests for Buildium::RentalOwnerRequestTaskSearchMessage
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Buildium::RentalOwnerRequestTaskSearchMessage do
  let(:instance) { Buildium::RentalOwnerRequestTaskSearchMessage.new }

  describe 'test an instance of RentalOwnerRequestTaskSearchMessage' do
    it 'should create an instance of RentalOwnerRequestTaskSearchMessage' do
      expect(instance).to be_instance_of(Buildium::RentalOwnerRequestTaskSearchMessage)
    end
  end
