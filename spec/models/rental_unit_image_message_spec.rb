...
# Unit tests for Buildium::RentalUnitImageMessage
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Buildium::RentalUnitImageMessage do
  let(:instance) { Buildium::RentalUnitImageMessage.new }

  describe 'test an instance of RentalUnitImageMessage' do
    it 'should create an instance of RentalUnitImageMessage' do
      expect(instance).to be_instance_of(Buildium::RentalUnitImageMessage)
    end
  end
  ...
  describe 'test attribute "provider"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["None", "YouTube", "Vimeo"])
  ...
  describe 'test attribute "show_in_listing"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
