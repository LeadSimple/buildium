...
# Unit tests for Buildium::RentalUnitMessage
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Buildium::RentalUnitMessage do
  let(:instance) { Buildium::RentalUnitMessage.new }

  describe 'test an instance of RentalUnitMessage' do
    it 'should create an instance of RentalUnitMessage' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Buildium::RentalUnitMessage)
    end
  end
  ...
  describe 'test attribute "is_unit_listed"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  describe 'test attribute "is_unit_occupied"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
