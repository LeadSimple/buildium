...
# Unit tests for Buildium::RentalUnitsPostMessage
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Buildium::RentalUnitsPostMessage do
  let(:instance) { Buildium::RentalUnitsPostMessage.new }

  describe 'test an instance of RentalUnitsPostMessage' do
    it 'should create an instance of RentalUnitsPostMessage' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Buildium::RentalUnitsPostMessage)
    end
  end
