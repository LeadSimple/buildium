...
# Unit tests for Buildium::ResidentCenterUserReferenceMessage
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Buildium::ResidentCenterUserReferenceMessage do
  let(:instance) { Buildium::ResidentCenterUserReferenceMessage.new }

  describe 'test an instance of ResidentCenterUserReferenceMessage' do
    it 'should create an instance of ResidentCenterUserReferenceMessage' do
      expect(instance).to be_instance_of(Buildium::ResidentCenterUserReferenceMessage)
    end
  end
  ...
  describe 'test attribute "user_type"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["Tenant", "AssociationOwner"])
