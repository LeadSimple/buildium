...
# Unit tests for Buildium::ResidentRequestTaskPutMessage
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Buildium::ResidentRequestTaskPutMessage do
  let(:instance) { Buildium::ResidentRequestTaskPutMessage.new }

  describe 'test an instance of ResidentRequestTaskPutMessage' do
    it 'should create an instance of ResidentRequestTaskPutMessage' do
      expect(instance).to be_instance_of(Buildium::ResidentRequestTaskPutMessage)
    end
  end
