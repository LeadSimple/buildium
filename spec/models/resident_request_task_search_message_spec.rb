...
# Unit tests for Buildium::ResidentRequestTaskSearchMessage
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Buildium::ResidentRequestTaskSearchMessage do
  let(:instance) { Buildium::ResidentRequestTaskSearchMessage.new }

  describe 'test an instance of ResidentRequestTaskSearchMessage' do
    it 'should create an instance of ResidentRequestTaskSearchMessage' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Buildium::ResidentRequestTaskSearchMessage)
    end
  end
