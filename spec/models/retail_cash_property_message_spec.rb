...
# Unit tests for Buildium::RetailCashPropertyMessage
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Buildium::RetailCashPropertyMessage do
  let(:instance) { Buildium::RetailCashPropertyMessage.new }

  describe 'test an instance of RetailCashPropertyMessage' do
    it 'should create an instance of RetailCashPropertyMessage' do
      expect(instance).to be_instance_of(Buildium::RetailCashPropertyMessage)
    end
  end
  ...
  describe 'test attribute "type"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["Association", "Rental"])
