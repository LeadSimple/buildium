...
# Unit tests for Buildium::RetailCashUnitMessage
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Buildium::RetailCashUnitMessage do
  let(:instance) { Buildium::RetailCashUnitMessage.new }

  describe 'test an instance of RetailCashUnitMessage' do
    it 'should create an instance of RetailCashUnitMessage' do
      expect(instance).to be_instance_of(Buildium::RetailCashUnitMessage)
    end
  end
