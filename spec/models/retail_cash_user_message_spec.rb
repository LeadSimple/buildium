...
# Unit tests for Buildium::RetailCashUserMessage
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Buildium::RetailCashUserMessage do
  let(:instance) { Buildium::RetailCashUserMessage.new }

  describe 'test an instance of RetailCashUserMessage' do
    it 'should create an instance of RetailCashUserMessage' do
      expect(instance).to be_instance_of(Buildium::RetailCashUserMessage)
    end
  end
