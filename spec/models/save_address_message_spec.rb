...
# Unit tests for Buildium::SaveAddressMessage
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Buildium::SaveAddressMessage do
  let(:instance) { Buildium::SaveAddressMessage.new }

  describe 'test an instance of SaveAddressMessage' do
    it 'should create an instance of SaveAddressMessage' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Buildium::SaveAddressMessage)
    end
  end
