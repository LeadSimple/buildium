...
# Unit tests for Buildium::SaveEmergencyContactMessage
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Buildium::SaveEmergencyContactMessage do
  let(:instance) { Buildium::SaveEmergencyContactMessage.new }

  describe 'test an instance of SaveEmergencyContactMessage' do
    it 'should create an instance of SaveEmergencyContactMessage' do
      expect(instance).to be_instance_of(Buildium::SaveEmergencyContactMessage)
    end
  end
