...
# Unit tests for Buildium::TaskCategoryMessage
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Buildium::TaskCategoryMessage do
  let(:instance) { Buildium::TaskCategoryMessage.new }

  describe 'test an instance of TaskCategoryMessage' do
    it 'should create an instance of TaskCategoryMessage' do
      expect(instance).to be_instance_of(Buildium::TaskCategoryMessage)
    end
  end
