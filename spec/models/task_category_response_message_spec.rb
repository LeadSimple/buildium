...
# Unit tests for Buildium::TaskCategoryResponseMessage
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Buildium::TaskCategoryResponseMessage do
  let(:instance) { Buildium::TaskCategoryResponseMessage.new }

  describe 'test an instance of TaskCategoryResponseMessage' do
    it 'should create an instance of TaskCategoryResponseMessage' do
      expect(instance).to be_instance_of(Buildium::TaskCategoryResponseMessage)
    end
  end
