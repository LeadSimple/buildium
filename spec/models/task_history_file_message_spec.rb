...
# Unit tests for Buildium::TaskHistoryFileMessage
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Buildium::TaskHistoryFileMessage do
  let(:instance) { Buildium::TaskHistoryFileMessage.new }

  describe 'test an instance of TaskHistoryFileMessage' do
    it 'should create an instance of TaskHistoryFileMessage' do
      expect(instance).to be_instance_of(Buildium::TaskHistoryFileMessage)
    end
  end
