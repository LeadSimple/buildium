...
# Unit tests for Buildium::TaskSearchMessage
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Buildium::TaskSearchMessage do
  let(:instance) { Buildium::TaskSearchMessage.new }

  describe 'test an instance of TaskSearchMessage' do
    it 'should create an instance of TaskSearchMessage' do
      expect(instance).to be_instance_of(Buildium::TaskSearchMessage)
    end
  end
