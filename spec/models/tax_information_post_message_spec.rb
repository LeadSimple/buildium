...
# Unit tests for Buildium::TaxInformationPostMessage
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Buildium::TaxInformationPostMessage do
  let(:instance) { Buildium::TaxInformationPostMessage.new }

  describe 'test an instance of TaxInformationPostMessage' do
    it 'should create an instance of TaxInformationPostMessage' do
      expect(instance).to be_instance_of(Buildium::TaxInformationPostMessage)
    end
  end
