...
# Unit tests for Buildium::TaxInformationSaveMessage
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Buildium::TaxInformationSaveMessage do
  let(:instance) { Buildium::TaxInformationSaveMessage.new }

  describe 'test an instance of TaxInformationSaveMessage' do
    it 'should create an instance of TaxInformationSaveMessage' do
      expect(instance).to be_instance_of(Buildium::TaxInformationSaveMessage)
    end
  end
