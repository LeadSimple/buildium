...
# Unit tests for Buildium::TenantMessage
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Buildium::TenantMessage do
  let(:instance) { Buildium::TenantMessage.new }

  describe 'test an instance of TenantMessage' do
    it 'should create an instance of TenantMessage' do
      expect(instance).to be_instance_of(Buildium::TenantMessage)
    end
  end
  ...
  describe 'test attribute "sms_opt_in_status"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
