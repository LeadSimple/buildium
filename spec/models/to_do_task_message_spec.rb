...
# Unit tests for Buildium::ToDoTaskMessage
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Buildium::ToDoTaskMessage do
  let(:instance) { Buildium::ToDoTaskMessage.new }

  describe 'test an instance of ToDoTaskMessage' do
    it 'should create an instance of ToDoTaskMessage' do
      expect(instance).to be_instance_of(Buildium::ToDoTaskMessage)
    end
  end
