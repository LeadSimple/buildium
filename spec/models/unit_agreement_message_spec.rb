...
# Unit tests for Buildium::UnitAgreementMessage
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Buildium::UnitAgreementMessage do
  let(:instance) { Buildium::UnitAgreementMessage.new }

  describe 'test an instance of UnitAgreementMessage' do
    it 'should create an instance of UnitAgreementMessage' do
      expect(instance).to be_instance_of(Buildium::UnitAgreementMessage)
    end
  end
