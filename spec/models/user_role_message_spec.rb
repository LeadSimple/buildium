...
# Unit tests for Buildium::UserRoleMessage
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Buildium::UserRoleMessage do
  let(:instance) { Buildium::UserRoleMessage.new }

  describe 'test an instance of UserRoleMessage' do
    it 'should create an instance of UserRoleMessage' do
      expect(instance).to be_instance_of(Buildium::UserRoleMessage)
    end
  end
