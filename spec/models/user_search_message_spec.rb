...
# Unit tests for Buildium::UserSearchMessage
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Buildium::UserSearchMessage do
  let(:instance) { Buildium::UserSearchMessage.new }

  describe 'test an instance of UserSearchMessage' do
    it 'should create an instance of UserSearchMessage' do
      expect(instance).to be_instance_of(Buildium::UserSearchMessage)
    end
  end
