...
# Unit tests for Buildium::VendorCreditLineItemMessage
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Buildium::VendorCreditLineItemMessage do
  let(:instance) { Buildium::VendorCreditLineItemMessage.new }

  describe 'test an instance of VendorCreditLineItemMessage' do
    it 'should create an instance of VendorCreditLineItemMessage' do
      expect(instance).to be_instance_of(Buildium::VendorCreditLineItemMessage)
    end
  end
