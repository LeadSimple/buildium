...
# Unit tests for Buildium::VendorMessage
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Buildium::VendorMessage do
  let(:instance) { Buildium::VendorMessage.new }

  describe 'test an instance of VendorMessage' do
    it 'should create an instance of VendorMessage' do
      expect(instance).to be_instance_of(Buildium::VendorMessage)
    end
  end
