...
# Unit tests for Buildium::VendorRefundMessage
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Buildium::VendorRefundMessage do
  let(:instance) { Buildium::VendorRefundMessage.new }

  describe 'test an instance of VendorRefundMessage' do
    it 'should create an instance of VendorRefundMessage' do
      expect(instance).to be_instance_of(Buildium::VendorRefundMessage)
    end
  end
