...
# Unit tests for Buildium::VendorTransactionMessage
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Buildium::VendorTransactionMessage do
  let(:instance) { Buildium::VendorTransactionMessage.new }

  describe 'test an instance of VendorTransactionMessage' do
    it 'should create an instance of VendorTransactionMessage' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Buildium::VendorTransactionMessage)
    end
  end
