...
# Unit tests for Buildium::VideoLinkRequestPostMessage
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Buildium::VideoLinkRequestPostMessage do
  let(:instance) { Buildium::VideoLinkRequestPostMessage.new }

  describe 'test an instance of VideoLinkRequestPostMessage' do
    it 'should create an instance of VideoLinkRequestPostMessage' do
      expect(instance).to be_instance_of(Buildium::VideoLinkRequestPostMessage)
    end
  end
