...
# Unit tests for Buildium::WorkOrderEntryContactMessage
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Buildium::WorkOrderEntryContactMessage do
  let(:instance) { Buildium::WorkOrderEntryContactMessage.new }

  describe 'test an instance of WorkOrderEntryContactMessage' do
    it 'should create an instance of WorkOrderEntryContactMessage' do
      expect(instance).to be_instance_of(Buildium::WorkOrderEntryContactMessage)
    end
  end
