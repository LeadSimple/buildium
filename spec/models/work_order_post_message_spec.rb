...
# Unit tests for Buildium::WorkOrderPostMessage
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Buildium::WorkOrderPostMessage do
  let(:instance) { Buildium::WorkOrderPostMessage.new }

  describe 'test an instance of WorkOrderPostMessage' do
    it 'should create an instance of WorkOrderPostMessage' do
      expect(instance).to be_instance_of(Buildium::WorkOrderPostMessage)
    end
  end
